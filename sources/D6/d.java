...
public enum d {
    ...
    static {
        for (d dVar : values()) {
            for (int i : dVar.values) {
                VALUE_TO_ECI.put(Integer.valueOf(i), dVar);
            }
    ...
    public static d getCharacterSetECIByName(String str) {
        return (d) NAME_TO_ECI.get(str);
    }

    public static d getCharacterSetECIByValue(int i) throws x6.g {
        if (i < 0 || i >= 900) {
            throw x6.g.a();
        }
        return (d) VALUE_TO_ECI.get(Integer.valueOf(i));
    }
