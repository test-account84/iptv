...
final class Reflector {
    ...
    private static ParameterizedType getParameterType(Constructor constructor, int i) {
        ParameterizedType[] genericParameterTypes = constructor.getGenericParameterTypes();
        if (genericParameterTypes.length <= i) {
            return null;
        }
        ParameterizedType parameterizedType = genericParameterTypes[i];
    ...
    private static ParameterizedType getReturnType(Method method) {
        ParameterizedType genericReturnType = method.getGenericReturnType();
    ...
    private static ParameterizedType getParameterType(Method method, int i) {
        ParameterizedType[] genericParameterTypes = method.getGenericParameterTypes();
        if (genericParameterTypes.length <= i) {
            return null;
        }
        ParameterizedType parameterizedType = genericParameterTypes[i];
