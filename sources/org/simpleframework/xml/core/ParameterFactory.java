...
class ParameterFactory {
    ...
    public Parameter getInstance(Constructor constructor, Annotation annotation, Annotation annotation2, int i) throws Exception {
        ...
        return (Parameter) (annotation2 != null ? constructor2.newInstance(new Object[]{constructor, annotation, annotation2, this.format, Integer.valueOf(i)}) : constructor2.newInstance(new Object[]{constructor, annotation, this.format, Integer.valueOf(i)}));
    }
}
