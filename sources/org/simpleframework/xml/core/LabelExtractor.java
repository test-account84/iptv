...
class LabelExtractor {
    ...
    private Annotation[] getAnnotations(Annotation annotation) throws Exception {
        ...
        return declaredMethods.length > 0 ? (Annotation[]) declaredMethods[0].invoke(annotation, (Object[]) null) : new Annotation[0];
    }
    ...
    private LabelGroup getUnion(Contact contact, Annotation annotation) throws Exception {
        ...
        return new LabelGroup((List) linkedList);
    }
    ...
    public List getList(Contact contact, Annotation annotation) throws Exception {
        LabelGroup group = getGroup(contact, annotation, getKey(contact, annotation));
    ...
    private Label getLabel(Contact contact, Annotation annotation, Annotation annotation2) throws Exception {
        ...
        return (Label) (annotation2 != null ? constructor.newInstance(new Object[]{contact, annotation, annotation2, this.format}) : constructor.newInstance(new Object[]{contact, annotation, this.format}));
    }
}
