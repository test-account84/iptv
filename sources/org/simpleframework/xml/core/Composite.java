...
class Composite implements Converter {
    ...
    public static class Builder {
        ...
        public Object read(InputNode inputNode) throws Exception {
            ...
            Composite.access$100(this.composite, inputNode, instance, this.schema);
            Composite.access$200(this.composite, inputNode, instance, section);
            Composite.access$300(this.composite, inputNode, instance, section);
            Composite.access$400(this.composite, inputNode, instance, section);
    ...
    public class Injector extends Builder {
        ...
        public Object read(InputNode inputNode) throws Exception {
            Section section = this.schema.getSection();
            Composite.access$100(this.composite, inputNode, null, this.schema);
            Composite.access$200(this.composite, inputNode, null, section);
            Composite.access$300(this.composite, inputNode, null, section);
            Composite.access$400(this.composite, inputNode, null, section);
            return readInject(inputNode);
        }

        public /* synthetic */ Injector(Composite composite, Composite composite2, Criteria criteria, Schema schema, Instance instance, 1 r6) {
    ...
    public static /* synthetic */ void access$100(Composite composite, InputNode inputNode, Object obj, Schema schema) throws Exception {
        composite.readVersion(inputNode, obj, schema);
    }

    public static /* synthetic */ void access$200(Composite composite, InputNode inputNode, Object obj, Section section) throws Exception {
        composite.readText(inputNode, obj, section);
    }

    public static /* synthetic */ void access$300(Composite composite, InputNode inputNode, Object obj, Section section) throws Exception {
        composite.readAttributes(inputNode, obj, section);
    }

    public static /* synthetic */ void access$400(Composite composite, InputNode inputNode, Object obj, Section section) throws Exception {
    ...
    private Builder read(Schema schema, Instance instance) throws Exception {
        return schema.getInstantiator().isDefault() ? new Builder(this, this.criteria, schema, instance) : new Injector(this, this, this.criteria, schema, instance, null);
    }
