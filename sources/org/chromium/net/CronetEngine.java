...
public abstract class CronetEngine {
    ...
    public static class Builder {
        ...
        private static ICronetEngineBuilder createBuilderDelegate(Context context) {
            ...
            if (Log.isLoggable(CronetEngine.access$000(), 3)) {
                Log.d(CronetEngine.access$000(), String.format("Using '%s' provider for creating CronetEngine.Builder.", new Object[]{cronetProvider}));
            }
