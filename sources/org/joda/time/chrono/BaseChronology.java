    ...
    public void validate(ReadablePartial readablePartial, int[] iArr) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (i2 < field.getMinimumValue()) {
                throw new IllegalFieldValueException(field.getType(), (Number) Integer.valueOf(i2), (Number) Integer.valueOf(field.getMinimumValue()), (Number) null);
            }
            if (i2 > field.getMaximumValue()) {
                throw new IllegalFieldValueException(field.getType(), (Number) Integer.valueOf(i2), (Number) null, (Number) Integer.valueOf(field.getMaximumValue()));
            }
        }
