...
public class NetscapeDraftSpec extends CookieSpecBase {
    ...
    public NetscapeDraftSpec(String[] strArr) {
        super(new BasicPathHandler(), new NetscapeDomainHandler(), new BasicSecureHandler(), new BasicCommentHandler(), new BasicExpiresHandler(strArr != null ? (String[]) strArr.clone() : new String[]{"EEE, dd-MMM-yy HH:mm:ss z"}));
    }
