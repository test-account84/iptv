...
public abstract class CookieSpecBase extends AbstractCookieSpec {
    ...
    public boolean match(Cookie cookie, CookieOrigin cookieOrigin) {
        ...
        Iterator it = getAttribHandlers().iterator();
        while (it.hasNext()) {
            if (!((CookieAttributeHandler) it.next()).match(cookie, cookieOrigin)) {
                return false;
            }
        }
        return true;
    ...
    public void validate(Cookie cookie, CookieOrigin cookieOrigin) throws MalformedCookieException {
        ...
        Iterator it = getAttribHandlers().iterator();
        while (it.hasNext()) {
            ((CookieAttributeHandler) it.next()).validate(cookie, cookieOrigin);
        }
    }

    public CookieSpecBase(HashMap hashMap) {
        super(hashMap);
    }
