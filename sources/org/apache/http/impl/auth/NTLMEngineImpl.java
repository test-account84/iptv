...
final class NTLMEngineImpl implements NTLMEngine {
    ...
    public static class CipherGen {
        ...
        public CipherGen(String str, String str2, String str3, byte[] bArr, String str4, byte[] bArr2) {
            this(NTLMEngineImpl.access$000(), System.currentTimeMillis(), str, str2, str3, bArr, str4, bArr2);
        }
        ...
        public byte[] getLMResponse() throws NTLMEngineException {
            if (this.lmResponse == null) {
                this.lmResponse = NTLMEngineImpl.access$400(getLMHash(), this.challenge);
            }
        ...
        public byte[] getLMv2Hash() throws NTLMEngineException {
            if (this.lmv2Hash == null) {
                this.lmv2Hash = NTLMEngineImpl.access$600(this.domain, this.user, getNTLMHash());
            }
        ...
        public byte[] getLMv2Response() throws NTLMEngineException {
            if (this.lmv2Response == null) {
                this.lmv2Response = NTLMEngineImpl.access$900(getLMv2Hash(), this.challenge, getClientChallenge());
            }
        ...
        public byte[] getLanManagerSessionKey() throws NTLMEngineException {
            if (this.lanManagerSessionKey == null) {
                try {
                    ...
                    Key access$1000 = NTLMEngineImpl.access$1000(bArr, 0);
                    Key access$10002 = NTLMEngineImpl.access$1000(bArr, 7);
                    byte[] bArr2 = new byte[8];
                    System.arraycopy(getLMResponse(), 0, bArr2, 0, 8);
                    Cipher cipher = Cipher.getInstance("DES/ECB/NoPadding");
                    cipher.init(1, access$1000);
                    byte[] doFinal = cipher.doFinal(bArr2);
                    Cipher cipher2 = Cipher.getInstance("DES/ECB/NoPadding");
                    cipher2.init(1, access$10002);
        ...
        public byte[] getNTLMResponse() throws NTLMEngineException {
            if (this.ntlmResponse == null) {
                this.ntlmResponse = NTLMEngineImpl.access$400(getNTLMHash(), this.challenge);
            }
        ...
        public byte[] getNTLMv2Blob() throws NTLMEngineException {
            if (this.ntlmv2Blob == null) {
                this.ntlmv2Blob = NTLMEngineImpl.access$800(getClientChallenge2(), this.targetInformation, getTimestamp());
            }
        ...
        public byte[] getNTLMv2Hash() throws NTLMEngineException {
            if (this.ntlmv2Hash == null) {
                this.ntlmv2Hash = NTLMEngineImpl.access$700(this.domain, this.user, getNTLMHash());
            }
        ...
        public byte[] getNTLMv2Response() throws NTLMEngineException {
            if (this.ntlmv2Response == null) {
                this.ntlmv2Response = NTLMEngineImpl.access$900(getNTLMv2Hash(), this.challenge, getNTLMv2Blob());
            }
        ...
        public CipherGen(String str, String str2, String str3, byte[] bArr, String str4, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6) {
            this(NTLMEngineImpl.access$000(), System.currentTimeMillis(), str, str2, str3, bArr, str4, bArr2, bArr3, bArr4, bArr5, bArr6);
        }
    ...
    public static class Handle {
        ...
        public Handle(byte[] bArr, Mode mode, boolean z) throws NTLMEngineException {
            ...
            try {
                ...
                md52.update(bArr);
                if (mode == Mode.CLIENT) {
                    md5.update(NTLMEngineImpl.access$1100());
                    md52.update(NTLMEngineImpl.access$1200());
                } else {
                    md5.update(NTLMEngineImpl.access$1300());
                    md52.update(NTLMEngineImpl.access$1400());
                }
        ...
        private byte[] computeSignature(byte[] bArr) throws NTLMEngineException {
            ...
            NTLMEngineImpl.access$1600(bArr2, 12, this.sequenceNumber);
            return bArr2;
        }
    ...
    public static class NTLMMessage {
        ...
        public byte[] readSecurityBuffer(int i) throws NTLMEngineException {
            return NTLMEngineImpl.access$2100(this.messageContents, i);
        }

        public int readULong(int i) throws NTLMEngineException {
            return NTLMEngineImpl.access$2000(this.messageContents, i);
        }

        public int readUShort(int i) throws NTLMEngineException {
            return NTLMEngineImpl.access$1900(this.messageContents, i);
        }

        public NTLMMessage(String str, int i) throws NTLMEngineException {
            this(Base64.decodeBase64(str.getBytes(NTLMEngineImpl.access$1700())), i);
        }

        public NTLMMessage(byte[] bArr, int i) throws NTLMEngineException {
            this.currentOutputPosition = 0;
            this.messageContents = bArr;
            if (bArr.length < NTLMEngineImpl.access$1800().length) {
                throw new NTLMEngineException("NTLM message decoding error - packet too short");
            }
            for (int i2 = 0; i2 < NTLMEngineImpl.access$1800().length; i2++) {
                if (this.messageContents[i2] != NTLMEngineImpl.access$1800()[i2]) {
                    throw new NTLMEngineException("NTLM message expected - instead got unrecognized bytes");
                }
            }
            int readULong = readULong(NTLMEngineImpl.access$1800().length);
            if (readULong == i) {
    ...
    public static class Type1Message extends NTLMMessage {
        ...
        public Type1Message(String str, String str2, Integer num) throws NTLMEngineException {
            ...
            String access$2200 = NTLMEngineImpl.access$2200(str2);
            String access$2300 = NTLMEngineImpl.access$2300(str);
            this.hostBytes = access$2200 != null ? access$2200.getBytes(NTLMEngineImpl.access$2400()) : null;
            this.domainBytes = access$2300 != null ? access$2300.toUpperCase(Locale.ROOT).getBytes(NTLMEngineImpl.access$2400()) : null;
        }
    }
    ...
    public static class Type2Message extends NTLMMessage {
        ...
        public Type2Message(String str) throws NTLMEngineException {
            this(Base64.decodeBase64(str.getBytes(NTLMEngineImpl.access$1700())));
        }
        ...
        public Type2Message(byte[] bArr) throws NTLMEngineException {
            ...
            if (getMessageLength() >= 20) {
                ...
                if (readSecurityBuffer.length != 0) {
                    this.target = new String(readSecurityBuffer, NTLMEngineImpl.access$2500(readULong));
                }
            }
    ...
    public static class Type3Message extends NTLMMessage {
        ...
        private byte[] addGssMicAvsToTargetInfo(byte[] bArr, Certificate certificate) throws NTLMEngineException {
            ...
            try {
                ...
                byte[] bArr3 = new byte[NTLMEngineImpl.access$2600().length + 20 + digest.length];
                NTLMEngineImpl.writeULong(bArr3, 53, 16);
                System.arraycopy(NTLMEngineImpl.access$2600(), 0, bArr3, 20, NTLMEngineImpl.access$2600().length);
                System.arraycopy(digest, 0, bArr3, NTLMEngineImpl.access$2600().length + 20, digest.length);
        ...
        public Type3Message(String str, String str2, String str3, String str4, byte[] bArr, int i, String str5, byte[] bArr2, Certificate certificate, byte[] bArr3, byte[] bArr4) throws NTLMEngineException {
            this(NTLMEngineImpl.access$000(), System.currentTimeMillis(), str, str2, str3, str4, bArr, i, str5, bArr2, certificate, bArr3, bArr4);
        }
        ...
        public Type3Message(Random random, long j, String str, String str2, String str3, String str4, byte[] bArr, int i, String str5, byte[] bArr2, Certificate certificate, byte[] bArr3, byte[] bArr4) throws NTLMEngineException {
            ...
            Charset access$2500 = NTLMEngineImpl.access$2500(i);
            this.hostBytes = access$2200 != null ? access$2200.getBytes(access$2500) : null;
            this.domainBytes = access$2300 != null ? access$2300.toUpperCase(Locale.ROOT).getBytes(access$2500) : null;
    ...
    public static /* synthetic */ byte[] access$100(Random random) throws NTLMEngineException {
        return makeRandomChallenge(random);
    }

    public static /* synthetic */ Key access$1000(byte[] bArr, int i) {
        return createDESKey(bArr, i);
    }

    public static /* synthetic */ byte[] access$1100() {
        return SIGN_MAGIC_CLIENT;
    }

    public static /* synthetic */ byte[] access$1200() {
    ...
    public static /* synthetic */ byte[] access$1500(int i) {
        return encodeLong(i);
    }

    public static /* synthetic */ void access$1600(byte[] bArr, int i, int i2) {
        encodeLong(bArr, i, i2);
    }

    public static /* synthetic */ Charset access$1700() {
        return DEFAULT_CHARSET;
    }

    public static /* synthetic */ byte[] access$1800() {
        return SIGNATURE;
    }

    public static /* synthetic */ int access$1900(byte[] bArr, int i) throws NTLMEngineException {
        return readUShort(bArr, i);
    }

    public static /* synthetic */ byte[] access$200(Random random) throws NTLMEngineException {
        return makeSecondaryKey(random);
    }

    public static /* synthetic */ int access$2000(byte[] bArr, int i) throws NTLMEngineException {
        return readULong(bArr, i);
    }

    public static /* synthetic */ byte[] access$2100(byte[] bArr, int i) throws NTLMEngineException {
        return readSecurityBuffer(bArr, i);
    }

    public static /* synthetic */ String access$2200(String str) {
    ...
    public static /* synthetic */ Charset access$2400() {
        return UNICODE_LITTLE_UNMARKED;
    }

    public static /* synthetic */ Charset access$2500(int i) throws NTLMEngineException {
        return getCharset(i);
    }

    public static /* synthetic */ byte[] access$2600() {
        return MAGIC_TLS_SERVER_ENDPOINT;
    }

    public static /* synthetic */ byte[] access$300(String str) throws NTLMEngineException {
        return lmHash(str);
    }

    public static /* synthetic */ byte[] access$400(byte[] bArr, byte[] bArr2) throws NTLMEngineException {
        return lmResponse(bArr, bArr2);
    }

    public static /* synthetic */ byte[] access$500(String str) throws NTLMEngineException {
        return ntlmHash(str);
    }

    public static /* synthetic */ byte[] access$600(String str, String str2, byte[] bArr) throws NTLMEngineException {
        return lmv2Hash(str, str2, bArr);
    }

    public static /* synthetic */ byte[] access$700(String str, String str2, byte[] bArr) throws NTLMEngineException {
        return ntlmv2Hash(str, str2, bArr);
    }

    public static /* synthetic */ byte[] access$800(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        return createBlob(bArr, bArr2, bArr3);
    }

    public static /* synthetic */ byte[] access$900(byte[] bArr, byte[] bArr2, byte[] bArr3) throws NTLMEngineException {
    ...
    private static void encodeLong(byte[] bArr, int i, int i2) {
        bArr[i] = (byte) (i2 & 255);
    ...
    private static Charset getCharset(int i) throws NTLMEngineException {
        if ((i & 1) == 0) {
            return DEFAULT_CHARSET;
        }
    ...
    private static byte[] makeRandomChallenge(Random random) throws NTLMEngineException {
    ...
    private static byte[] makeSecondaryKey(Random random) throws NTLMEngineException {
        byte[] bArr = new byte[16];
        synchronized (random) {
            random.nextBytes(bArr);
        }
    ...
    private static byte[] encodeLong(int i) {
        byte[] bArr = new byte[4];
        encodeLong(bArr, 0, i);
        return bArr;
    }
