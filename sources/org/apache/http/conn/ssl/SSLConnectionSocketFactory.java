...
public class SSLConnectionSocketFactory implements LayeredConnectionSocketFactory {
    ...
    public static SSLConnectionSocketFactory getSystemSocketFactory() throws SSLInitializationException {
        return new SSLConnectionSocketFactory(javax.net.ssl.SSLSocketFactory.getDefault(), split(System.getProperty("https.protocols")), split(System.getProperty("https.cipherSuites")), getDefaultHostnameVerifier());
    }
    ...
    private void verifyHostname(SSLSocket sSLSocket, String str) throws IOException {
        try {
            ...
            throw new SSLPeerUnverifiedException("Certificate for <" + str + "> doesn't match any of the subject alternative names: " + DefaultHostnameVerifier.getSubjectAltNames(session.getPeerCertificates()[0]));
        } catch (IOException e) {
            try {
                sSLSocket.close();
