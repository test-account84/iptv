...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        public boolean matches(Element element, Element element2) {
            ...
            while (it.hasNext()) {
                if (((org.jsoup.nodes.Attribute) it.next()).getKey().startsWith(this.keyPrefix)) {
                    return true;
                }
            }
            return false;
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
        ...
        public String toString() {
            return this.a == 0 ? String.format(":%s(%d)", new Object[]{getPseudoClass(), Integer.valueOf(this.b)}) : this.b == 0 ? String.format(":%s(%dn)", new Object[]{getPseudoClass(), Integer.valueOf(this.a)}) : String.format(":%s(%dn%+d)", new Object[]{getPseudoClass(), Integer.valueOf(this.a), Integer.valueOf(this.b)});
        }
    ...
    public static class IsNthOfType extends CssNthEvaluator {
        ...
        public int calculatePosition(Element element, Element element2) {
            ...
            for (int i2 = 0; i2 < children.size(); i2++) {
                if (((Element) children.get(i2)).tag().equals(element2.tag())) {
                    i++;
                }
