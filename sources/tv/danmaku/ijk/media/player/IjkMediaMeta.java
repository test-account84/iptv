...
public class IjkMediaMeta {
    ...
    public static class IjkStreamMeta {
        ...
        public String getBitrateInline() {
            ...
            return j <= 0 ? "N/A" : j < 1000 ? String.format(Locale.US, "%d bit/s", new Object[]{Long.valueOf(j)}) : String.format(Locale.US, "%d kb/s", new Object[]{Long.valueOf(j / 1000)});
        }

        public String getChannelLayoutInline() {
            long j = this.mChannelLayout;
            return j <= 0 ? "N/A" : j == 4 ? "mono" : j == 3 ? "stereo" : String.format(Locale.US, "%x", new Object[]{Long.valueOf(j)});
        }
        ...
        public String getResolutionInline() {
            int i = this.mWidth;
            return (i <= 0 || this.mHeight <= 0) ? "N/A" : (this.mSarNum <= 0 || this.mSarDen <= 0) ? String.format(Locale.US, "%d x %d", new Object[]{Integer.valueOf(i), Integer.valueOf(this.mHeight)}) : String.format(Locale.US, "%d x %d [SAR %d:%d]", new Object[]{Integer.valueOf(i), Integer.valueOf(this.mHeight), Integer.valueOf(this.mSarNum), Integer.valueOf(this.mSarDen)});
        }

        public String getSampleRateInline() {
            int i = this.mSampleRate;
            return i <= 0 ? "N/A" : String.format(Locale.US, "%d Hz", new Object[]{Integer.valueOf(i)});
        }
    ...
    public static IjkMediaMeta parse(Bundle bundle) {
        ...
        ArrayList parcelableArrayList = ijkMediaMeta.getParcelableArrayList("streams");
