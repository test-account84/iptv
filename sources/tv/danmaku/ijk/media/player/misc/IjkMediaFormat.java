...
public class IjkMediaFormat implements IMediaFormat {
    ...
    public class 1 extends Formatter {
        public 1() {
            super(null);
        }
    ...
    public class 2 extends Formatter {
        public 2() {
            super(null);
        }
    ...
    public class 3 extends Formatter {
        public 3() {
            super(null);
        }
        ...
        public String doFormat(IjkMediaFormat ijkMediaFormat) {
            ...
            return integer < 1000 ? String.format(Locale.US, "%d bit/s", new Object[]{Integer.valueOf(integer)}) : String.format(Locale.US, "%d kb/s", new Object[]{Integer.valueOf(integer / 1000)});
        }
    }

    public class 4 extends Formatter {
        public 4() {
            super(null);
        }
    ...
    public class 5 extends Formatter {
        public 5() {
            super(null);
        }
    ...
    public class 6 extends Formatter {
        public 6() {
            super(null);
        }
        ...
        public String doFormat(IjkMediaFormat ijkMediaFormat) {
            ...
            return (integer3 <= 0 || integer4 <= 0) ? String.format(Locale.US, "%d x %d", new Object[]{Integer.valueOf(integer), Integer.valueOf(integer2)}) : String.format(Locale.US, "%d x %d [SAR %d:%d]", new Object[]{Integer.valueOf(integer), Integer.valueOf(integer2), Integer.valueOf(integer3), Integer.valueOf(integer4)});
        }
    }

    public class 7 extends Formatter {
        public 7() {
            super(null);
        }
    ...
    public class 8 extends Formatter {
        public 8() {
            super(null);
        }
    ...
    public class 9 extends Formatter {
        public 9() {
            super(null);
        }
        ...
        public String doFormat(IjkMediaFormat ijkMediaFormat) {
            ...
            long j = integer;
            return j == 4 ? "mono" : j == 3 ? "stereo" : String.format(Locale.US, "%x", new Object[]{Integer.valueOf(integer)});
        }
    }
    ...
    public static abstract class Formatter {
        ...
        public /* synthetic */ Formatter(1 r1) {
            this();
        }
    }
    ...
    public IjkMediaFormat(IjkMediaMeta.IjkStreamMeta ijkStreamMeta) {
        ...
        map.put("ijk-codec-long-name-ui", new 1());
        map.put("ijk-codec-name-ui", new 2());
        map.put("ijk-bit-rate-ui", new 3());
        map.put("ijk-profile-level-ui", new 4());
        map.put("ijk-pixel-format-ui", new 5());
        map.put("ijk-resolution-ui", new 6());
        map.put("ijk-frame-rate-ui", new 7());
        map.put("ijk-sample-rate-ui", new 8());
        map.put("ijk-channel-ui", new 9());
    ...
    public String getString(String str) {
        ...
        Map map = sFormatterMap;
        return map.containsKey(str) ? ((Formatter) map.get(str)).format(this) : this.mMediaFormat.getString(str);
    }
}
