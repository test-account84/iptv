...
public abstract class e {
    ...
    public static class b {
            ...
            while (i3 < fArr2.length) {
                if (c3 != 'A') {
                    if (c3 == 'C') {
                        ...
                        int i29 = i3 + 6;
                        i2 = i3;
                        c(path, f15, f16, fArr2[i28] + f15, fArr2[i29] + f16, fArr2[i3], fArr2[i3 + 1], fArr2[i3 + 2], fArr2[i3 + 3] != 0.0f, fArr2[i3 + 4] != 0.0f);
                        f15 += fArr2[i28];
                        f16 += fArr2[i29];
                    }
                    i3 = i2 + i;
                    ...
                    int i30 = i2 + 5;
                    int i31 = i2 + 6;
                    c(path, f15, f16, fArr2[i30], fArr2[i31], fArr2[i2], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != 0.0f, fArr2[i2 + 4] != 0.0f);
                    f15 = fArr2[i30];
                    f16 = fArr2[i31];
                }
                f12 = f16;
        ...
        public static void c(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            double d22 = d * d6;
            double d23 = d2 * d9;
            b(path, (d22 * cos) - (d23 * sin), (d22 * sin) + (d23 * cos), d6, d9, d3, d5, radians, atan2, atan22);
        }
