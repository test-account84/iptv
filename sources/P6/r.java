    ...
    public static String a(String str) {
        ...
        for (Object[] objArr : b) {
            if (objArr[0].equals(substring)) {
                Object obj = objArr[1];
                return obj == a ? c(2, ((Integer) objArr[2]).intValue(), str) : b(2, ((Integer) obj).intValue(), str);
            }
        }
        if (str.length() < 3) {
            throw x6.k.a();
        ...
        for (Object[] objArr2 : c) {
            if (objArr2[0].equals(substring2)) {
                ...
                return obj2 == a ? c(3, ((Integer) objArr2[2]).intValue(), str) : b(3, ((Integer) obj2).intValue(), str);
            }
        }
        for (Object[] objArr3 : d) {
            if (objArr3[0].equals(substring2)) {
                Object obj3 = objArr3[1];
                return obj3 == a ? c(4, ((Integer) objArr3[2]).intValue(), str) : b(4, ((Integer) obj3).intValue(), str);
            }
        }
        if (str.length() < 4) {
            throw x6.k.a();
        ...
        for (Object[] objArr4 : e) {
            if (objArr4[0].equals(substring3)) {
                ...
                return obj4 == a ? c(4, ((Integer) objArr4[2]).intValue(), str) : b(4, ((Integer) obj4).intValue(), str);
            }
        }
        throw x6.k.a();
    }
