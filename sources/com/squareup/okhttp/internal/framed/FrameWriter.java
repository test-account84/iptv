...
public interface FrameWriter extends Closeable {
    ...
    void headers(int i, List list) throws IOException;
    ...
    void synReply(boolean z, int i, List list) throws IOException;

    void synStream(boolean z, boolean z2, int i, int i2, List list) throws IOException;
