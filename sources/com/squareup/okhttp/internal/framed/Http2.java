...
public final class Http2 implements Variant {
    ...
    public static final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() throws IOException {
            ...
            if (Http2.access$100().isLoggable(Level.FINE)) {
                Http2.access$100().fine(FrameLogger.formatHeader(true, this.streamId, this.length, readByte, this.flags));
            }
            int readInt = this.source.readInt() & Integer.MAX_VALUE;
            this.streamId = readInt;
            if (readByte != 9) {
                throw Http2.access$200("%s != TYPE_CONTINUATION", new Object[]{Byte.valueOf(readByte)});
            }
            if (readInt != i) {
    ...
    public static final class FrameLogger {
        ...
        public static String formatHeader(boolean z, int i, int i2, byte b, byte b2) {
            String[] strArr = TYPES;
            return String.format("%s 0x%08x %5d %-13s %s", new Object[]{z ? "<<" : ">>", Integer.valueOf(i), Integer.valueOf(i2), b < strArr.length ? strArr[b] : String.format("0x%02x", new Object[]{Byte.valueOf(b)}), formatFlags(b, b2)});
        }
    }
    ...
    public static final class Reader implements FrameReader {
        ...
        private void readData(FrameReader.Handler handler, int i, byte b, int i2) throws IOException {
            ...
            handler.data(z, i2, this.source, Http2.access$400(i, b, readByte));
        ...
        private void readGoAway(FrameReader.Handler handler, int i, byte b, int i2) throws IOException {
            ...
            if (fromHttp2 == null) {
                throw Http2.access$200("TYPE_GOAWAY unexpected error code: %d", new Object[]{Integer.valueOf(readInt2)});
            }
        ...
        private List readHeaderBlock(int i, short s, byte b, int i2) throws IOException {
        ...
        private void readHeaders(FrameReader.Handler handler, int i, byte b, int i2) throws IOException {
            ...
            handler.headers(false, z, i2, -1, readHeaderBlock(Http2.access$400(i, b, readByte), readByte, b, i2), HeadersMode.HTTP_20_HEADERS);
        }
        ...
        private void readPushPromise(FrameReader.Handler handler, int i, byte b, int i2) throws IOException {
            ...
            short readByte = (b & 8) != 0 ? (short) (this.source.readByte() & 255) : (short) 0;
            handler.pushPromise(i2, this.source.readInt() & Integer.MAX_VALUE, readHeaderBlock(Http2.access$400(i - 4, b, readByte), readByte, b, i2));
        }
        ...
        private void readRstStream(FrameReader.Handler handler, int i, byte b, int i2) throws IOException {
            ...
            if (fromHttp2 == null) {
                throw Http2.access$200("TYPE_RST_STREAM unexpected error code: %d", new Object[]{Integer.valueOf(readInt)});
            }
                ...
                switch (readShort) {
                    ...
                    case 5:
                        if (readInt < 16384 || readInt > 16777215) {
                            throw Http2.access$200("PROTOCOL_ERROR SETTINGS_MAX_FRAME_SIZE: %s", new Object[]{Integer.valueOf(readInt)});
                        }
                        break;
                        break;
                    default:
                        throw Http2.access$200("PROTOCOL_ERROR invalid settings id: %s", new Object[]{Short.valueOf(readShort)});
                }
        ...
        private void readWindowUpdate(FrameReader.Handler handler, int i, byte b, int i2) throws IOException {
            ...
            if (readInt == 0) {
                throw Http2.access$200("windowSizeIncrement was 0", new Object[]{Long.valueOf(readInt)});
            }
        ...
        public boolean nextFrame(FrameReader.Handler handler) throws IOException {
            try {
                ...
                int readInt = this.source.readInt() & Integer.MAX_VALUE;
                if (Http2.access$100().isLoggable(Level.FINE)) {
                    Http2.access$100().fine(FrameLogger.formatHeader(true, readInt, access$300, readByte, readByte2));
                }
                switch (readByte) {
                    case 0:
        ...
        public void readConnectionPreface() throws IOException {
            ...
            ByteString readByteString = this.source.readByteString(Http2.access$000().size());
            if (Http2.access$100().isLoggable(Level.FINE)) {
                Http2.access$100().fine(String.format("<< CONNECTION %s", new Object[]{readByteString.hex()}));
            }
            if (!Http2.access$000().equals(readByteString)) {
                throw Http2.access$200("Expected a connection header but was %s", new Object[]{readByteString.utf8()});
            }
        }
    ...
    public static final class Writer implements FrameWriter {
        ...
        public void frameHeader(int i, int i2, byte b, byte b2) throws IOException {
            if (Http2.access$100().isLoggable(Level.FINE)) {
                Http2.access$100().fine(FrameLogger.formatHeader(false, i, i2, b, b2));
            }
            int i3 = this.maxFrameSize;
            if (i2 > i3) {
                throw Http2.access$500("FRAME_SIZE_ERROR length > %d: %d", new Object[]{Integer.valueOf(i3), Integer.valueOf(i2)});
            }
            if ((Integer.MIN_VALUE & i) != 0) {
                throw Http2.access$500("reserved bit set: %s", new Object[]{Integer.valueOf(i)});
            }
            Http2.access$600(this.sink, i2);
        ...
        public synchronized void headers(int i, List list) throws IOException {
            if (this.closed) {
                throw new IOException("closed");
            }
        ...
        public synchronized void pushPromise(int i, int i2, List list) throws IOException {
            if (this.closed) {
                throw new IOException("closed");
            }
        ...
        public synchronized void synReply(boolean z, int i, List list) throws IOException {
            if (this.closed) {
                throw new IOException("closed");
            }
            headers(z, i, list);
        ...
        public synchronized void synStream(boolean z, boolean z2, int i, int i2, List list) throws IOException {
            if (z2) {
        ...
        public void headers(boolean z, int i, List list) throws IOException {
            if (this.closed) {
                throw new IOException("closed");
            }
            this.hpackWriter.writeHeaders(list);
    ...
    public static /* synthetic */ ByteString access$000() {
    ...
    public static /* synthetic */ IOException access$200(String str, Object[] objArr) throws IOException {
        return ioException(str, objArr);
    }

    public static /* synthetic */ int access$300(BufferedSource bufferedSource) throws IOException {
        return readMedium(bufferedSource);
    }

    public static /* synthetic */ int access$400(int i, byte b, short s) throws IOException {
        return lengthWithoutPadding(i, b, s);
    }

    public static /* synthetic */ IllegalArgumentException access$500(String str, Object[] objArr) {
        return illegalArgument(str, objArr);
    }

    public static /* synthetic */ void access$600(BufferedSink bufferedSink, int i) throws IOException {
        writeMedium(bufferedSink, i);
    }
