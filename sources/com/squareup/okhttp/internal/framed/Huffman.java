...
class Huffman {
    ...
    public static final class Node {
        ...
        public static /* synthetic */ Node[] access$000(Node node) {
            return node.children;
        }

        public static /* synthetic */ int access$100(Node node) {
            return node.symbol;
        }
    ...
    private void addCode(int i, int i2, byte b) {
        ...
        while (b > 8) {
            b = (byte) (b - 8);
            int i3 = (i2 >>> b) & 255;
            if (Node.access$000(node2) == null) {
                throw new IllegalStateException("invalid dictionary: prefix not unique");
            }
            if (Node.access$000(node2)[i3] == null) {
                Node.access$000(node2)[i3] = new Node();
            }
            node2 = Node.access$000(node2)[i3];
        }
        int i4 = 8 - b;
        int i5 = (i2 << i4) & 255;
        int i6 = 1 << i4;
        for (int i7 = i5; i7 < i5 + i6; i7++) {
            Node.access$000(node2)[i7] = node;
        }
    }
    ...
    public byte[] decode(byte[] bArr) throws IOException {
        ...
        for (byte b : bArr) {
            ...
            i2 += 8;
            while (i2 >= 8) {
                node = Node.access$000(node)[(i >>> (i2 - 8)) & 255];
                if (Node.access$000(node) == null) {
                    byteArrayOutputStream.write(Node.access$100(node));
                    i2 -= Node.access$200(node);
                    node = this.root;
                } else {
                    i2 -= 8;
                }
        ...
        while (i2 > 0) {
            Node node2 = Node.access$000(node)[(i << (8 - i2)) & 255];
            if (Node.access$000(node2) != null || Node.access$200(node2) > i2) {
                break;
            }
            byteArrayOutputStream.write(Node.access$100(node2));
            i2 -= Node.access$200(node2);
            node = this.root;
        }
