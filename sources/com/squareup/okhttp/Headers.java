...
public final class Headers {
    ...
    private Headers(Builder builder) {
        this.namesAndValues = (String[]) Builder.access$000(builder).toArray(new String[Builder.access$000(builder).size()]);
    }
    ...
    public Builder newBuilder() {
        ...
        Collections.addAll(Builder.access$000(builder), this.namesAndValues);
        return builder;
    }
    ...
    public /* synthetic */ Headers(Builder builder, 1 r2) {
        this(builder);
    }
