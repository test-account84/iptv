...
public class UnpiadInvoiceActivity extends b implements InvoiceData {
    ...
    public class countDown implements Runnable {
        ...
        public class 1 implements Runnable {
            ...
            public void run() {
                ...
                String R = w.R(UnpiadInvoiceActivity.this.i);
                String A = w.A(date);
                TextView textView = UnpiadInvoiceActivity.this.g;
                if (textView != null) {
                    textView.setText(R);
                }
                TextView textView2 = UnpiadInvoiceActivity.this.h;
                if (textView2 != null) {
                    textView2.setText(A);
                }
            }
        ...
        public final void a() {
            UnpiadInvoiceActivity.this.runOnUiThread(new 1());
        }
    ...
    public void j0(String str) {
        ...
        this.f.setVisibility(8);
        this.d.setText(getResources().getString(j.x4));
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(g.o1);
        this.d = findViewById(f.Rb);
        this.e = findViewById(f.Hd);
        ...
        new InvoicesApiHitClass(this, this.i, "UnPaid").a();
    }

    public void w(List list) {
        if (list != null && !list.isEmpty() && list.size() > 0) {
            b();
            this.e.setAdapter(new UnpaidAdapter(this.i, list));
        } else {
            this.e.setVisibility(8);
            this.d.setVisibility(0);
            this.f.setVisibility(8);
