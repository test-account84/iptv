...
public class CancelInvoiceActivity extends b implements InvoiceData {
    ...
    public class CountDown implements Runnable {
        ...
        public class 1 implements Runnable {
            ...
            public void run() {
                ...
                String R = w.R(CancelInvoiceActivity.this.i);
                String A = w.A(date);
                TextView textView = CancelInvoiceActivity.this.h;
                if (textView != null) {
                    textView.setText(R);
                }
                TextView textView2 = CancelInvoiceActivity.this.g;
                if (textView2 != null) {
                    textView2.setText(A);
                }
            }
        ...
        public final void a() {
            CancelInvoiceActivity.this.runOnUiThread(new 1());
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        new InvoicesApiHitClass(this, this.i, "Cancelled").a();
    }
