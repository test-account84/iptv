...
public class SuspendedServiceActivity extends b implements AllServiceApiCallBack {
    ...
    public class 1 implements Runnable {
        ...
        public void run() {
            try {
                ...
                String R = w.R(SuspendedServiceActivity.this.j);
                String A = w.A(date);
                TextView textView = SuspendedServiceActivity.this.h;
                if (textView != null) {
                    textView.setText(R);
                }
                TextView textView2 = SuspendedServiceActivity.this.g;
                if (textView2 != null) {
                    textView2.setText(A);
                }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.i = findViewById;
        findViewById.setText(getResources().getString(j.Q3));
        this.j = this;
        ...
        new CommanApiHitClass(this, this.j, "Suspended").a();
    }
