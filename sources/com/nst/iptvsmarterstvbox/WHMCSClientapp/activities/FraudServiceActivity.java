...
public class FraudServiceActivity extends b implements AllServiceApiCallBack {
    ...
    public class 1 implements Runnable {
        ...
        public void run() {
            try {
                ...
                String R = w.R(FraudServiceActivity.this.j);
                String A = w.A(date);
                TextView textView = FraudServiceActivity.this.h;
                if (textView != null) {
                    textView.setText(R);
                }
                TextView textView2 = FraudServiceActivity.this.g;
                if (textView2 != null) {
                    textView2.setText(A);
                }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.i = findViewById;
        findViewById.setText(getResources().getString(j.O3));
        this.j = this;
        ...
        new CommanApiHitClass(this, this.j, "Fraud").a();
    }
