...
public class ActiveServiceActivity extends b implements AllServiceApiCallBack {
    ...
    public class 1 implements Runnable {
        ...
        public void run() {
            try {
                ...
                String R = w.R(ActiveServiceActivity.this.j);
                String A = w.A(date);
                TextView textView = ActiveServiceActivity.this.h;
                if (textView != null) {
                    textView.setText(R);
                }
                TextView textView2 = ActiveServiceActivity.this.g;
                if (textView2 != null) {
                    textView2.setText(A);
                }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.i = findViewById;
        this.j = this;
        findViewById.setText(getResources().getString(j.M3));
        ...
        new CommanApiHitClass(this, this.j, "Active").a();
    }
