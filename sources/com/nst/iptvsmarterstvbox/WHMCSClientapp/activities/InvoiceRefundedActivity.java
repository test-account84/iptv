...
public class InvoiceRefundedActivity extends b implements InvoiceData {
    ...
    public class countDown implements Runnable {
        ...
        public class 1 implements Runnable {
            ...
            public void run() {
                ...
                String R = w.R(InvoiceRefundedActivity.this.i);
                String A = w.A(date);
                TextView textView = InvoiceRefundedActivity.this.g;
                if (textView != null) {
                    textView.setText(R);
                }
                TextView textView2 = InvoiceRefundedActivity.this.h;
                if (textView2 != null) {
                    textView2.setText(A);
                }
            }
        ...
        public final void a() {
            InvoiceRefundedActivity.this.runOnUiThread(new 1());
        }
    ...
    public void j0(String str) {
        ...
        this.e.setText(getResources().getString(j.x4));
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        new InvoicesApiHitClass(this, this.i, "Refunded").a();
    }
