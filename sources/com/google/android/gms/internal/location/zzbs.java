...
public abstract class zzbs extends zzbp implements List, RandomAccess {
    private static final zzbv zza = new zzbq(zzbt.zza, 0);

    public static zzbs zzi() {
        return zzbt.zza;
    }

    public static zzbs zzj(Collection collection) {
        if (collection instanceof zzbp) {
            zzbs zze = ((zzbp) collection).zze();
            if (!zze.zzf()) {
                return zze;
            }
    ...
    public static zzbs zzk(Object[] objArr, int i) {
        return i == 0 ? zzbt.zza : new zzbt(objArr, i);
    }
    ...
    public zzbs subList(int i, int i2) {
        zzbm.zzc(i, i2, size());
        int i3 = i2 - i;
        return i3 == size() ? this : i3 == 0 ? zzbt.zza : new zzbr(this, i, i3);
    }

    /* renamed from: zzl, reason: merged with bridge method [inline-methods] */
    public final zzbv listIterator(int i) {
        zzbm.zzb(i, size(), "index");
        return isEmpty() ? zza : new zzbq(this, i);
    }
}
