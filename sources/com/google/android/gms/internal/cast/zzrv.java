...
final class zzrv implements zzvi {
    ...
    public final void zzA(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzruVar.zzp(i, (intValue >> 31) ^ (intValue + intValue));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            i3 += zzru.zzx((intValue2 >> 31) ^ (intValue2 + intValue2));
        }
        this.zza.zzq(i3);
        while (i2 < list.size()) {
            zzru zzruVar2 = this.zza;
            int intValue3 = ((Integer) list.get(i2)).intValue();
            zzruVar2.zzq((intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzC(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzruVar.zzr(i, (longValue >> 63) ^ (longValue + longValue));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            i3 += zzru.zzy((longValue2 >> 63) ^ (longValue2 + longValue2));
        }
        this.zza.zzq(i3);
        while (i2 < list.size()) {
            zzru zzruVar2 = this.zza;
            long longValue3 = ((Long) list.get(i2)).longValue();
            zzruVar2.zzs((longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
    ...
    public final void zzd(int i, zzrm zzrmVar) throws IOException {
    ...
    public final void zzp(int i, Object obj, zzua zzuaVar) throws IOException {
        zzru zzruVar = this.zza;
        zzruVar.zzo(i, 3);
    ...
    public final void zzu(int i, Object obj, zzua zzuaVar) throws IOException {
