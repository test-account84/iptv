...
interface zzvi {
    ...
    void zzD(int i, String str) throws IOException;
    ...
    void zzd(int i, zzrm zzrmVar) throws IOException;
    ...
    @Deprecated
    void zzp(int i, Object obj, zzua zzuaVar) throws IOException;
    ...
    void zzu(int i, Object obj, zzua zzuaVar) throws IOException;

    void zzv(int i, int i2) throws IOException;

    void zzw(int i, List list, boolean z) throws IOException;

    void zzx(int i, long j) throws IOException;
