...
public final class zzmg {
    ...
    private static zzmj zza(zzmj zzmjVar, zzmj zzmjVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzmjVar.zza()) {
            return zzmjVar2;
        }
        if (zzmjVar2.zza()) {
        ...
        BigInteger bigInteger3 = zzmjVar.zzd;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = zzmjVar2.zzd;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = zzmjVar.zzb.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzmjVar2.zzb.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = zzmjVar.zzc.multiply(zzmjVar2.zzd).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = zzmjVar2.zzc.multiply(zzmjVar.zzd).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (mod3.equals(mod4)) {
            return !mod5.equals(mod6) ? zzmj.zza : zza(zzmjVar, bigInteger, bigInteger2);
        }
        ...
        BigInteger add = zzmjVar.zzd.add(zzmjVar2.zzd);
        return new zzmj(mod12, mod13, add.multiply(add).mod(bigInteger2).subtract(mod).subtract(mod2).multiply(mod7).mod(bigInteger2));
    }

    private static zzmj zza(zzmj zzmjVar, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzmjVar.zzc.equals(BigInteger.ZERO)) {
            return zzmj.zza;
        }
        BigInteger bigInteger3 = zzmjVar.zzb;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = zzmjVar.zzc;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = mod2.multiply(mod2).mod(bigInteger2);
        BigInteger bigInteger5 = zzmjVar.zzd;
        BigInteger mod4 = bigInteger5.multiply(bigInteger5).mod(bigInteger2);
        BigInteger add = zzmjVar.zzb.add(mod2);
        ...
        BigInteger add3 = zzmjVar.zzc.add(zzmjVar.zzd);
