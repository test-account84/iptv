...
final class zzala extends zzahj implements RandomAccess {
    private static final zzala zza = new zzala(new Object[0], 0, false);
    private Object[] zzb;
    private int zzc;
    ...
    private zzala(Object[] objArr, int i, boolean z) {
        super(z);
        this.zzb = objArr;
        this.zzc = i;
    }
