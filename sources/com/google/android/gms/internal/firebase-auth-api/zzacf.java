...
public final class zzacf {
    ...
    */
    public static A5.m zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instructions count: 552
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.firebase-auth-api.zzacf.zza(com.google.android.gms.common.api.Status):A5.m");
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof l) {
            return ((l) exc).a().endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }

    public static m zza(Status status, g gVar, String str, String str2) {
        int I = status.I();
        if (I != 17012 && I != 17007 && I != 17025) {
            return zza(status);
        }
        return new r(zza(I), zza(zzb(I), status)).b(gVar).c(str).d(str2);
    }

    public static boolean zzb(Exception exc) {
        if (exc instanceof l) {
            return ((l) exc).a().endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }

    public static o zza(FirebaseAuth firebaseAuth, zzyk zzykVar, u uVar) {
        zzy.zza(firebaseAuth);
        zzy.zza(zzykVar);
        Pair pair = (Pair) zza.get(17078);
        return new o((String) pair.first, (String) pair.second, h.I(zzykVar, firebaseAuth, uVar));
    }
    ...
    private static String zza(String str, Status status) {
        ...
        return String.format(str + " [ %s ]", new Object[]{status.J()});
    }

    public static boolean zza(Exception exc) {
        if (exc instanceof l) {
            return ((l) exc).a().endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}
