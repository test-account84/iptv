...
public final class zzbb {
        ...
        switch (c) {
            ...
            case 4:
                ...
                while (zzk3.hasNext()) {
                    ...
                    double d4 = intValue;
                    if (d4 >= d && zzh.zzl(zzaeVar.zze(intValue), zzapVar)) {
            ...
            case 6:
                ...
                if (list.size() > 1) {
                    ...
                    d3 = Double.isNaN(zzb7.zzh().doubleValue()) ? zzaeVar.zzc() - 1 : zzh.zza(zzb7.zzh().doubleValue());
                    d2 = 0.0d;
                    if (d3 < 0.0d) {
                        d3 += zzaeVar.zzc();
                    }
                ...
                for (int min = (int) Math.min(zzaeVar.zzc(), d3); min >= 0; min--) {
            ...
            case 15:
                ...
                if (zzaeVar.zzc() != 0) {
                    ...
                    while (zzk4.hasNext()) {
                        ...
                        if (zzaeVar.zzs(intValue2) && zzaiVar2.zza(zzgVar, Arrays.asList(new zzap[]{zzaeVar.zze(intValue2), new zzah(Double.valueOf(intValue2)), zzaeVar})).zzg().booleanValue()) {
                            return zzap.zzk;
                        }
                    }
                }
            ...
            case 17:
                ...
                if (list.size() > 1) {
                    ...
                    if (max2 > 0) {
                        for (int i6 = zza3; i6 < Math.min(zzc6, zza3 + max2); i6++) {
    ...
    private static zzae zzb(zzae zzaeVar, zzg zzgVar, zzai zzaiVar, Boolean bool, Boolean bool2) {
        ...
        while (zzk.hasNext()) {
            ...
            if (zzaeVar.zzs(intValue)) {
                zzap zza = zzaiVar.zza(zzgVar, Arrays.asList(new zzap[]{zzaeVar.zze(intValue), new zzah(Double.valueOf(intValue)), zzaeVar}));
    ...
    private static zzap zzc(zzae zzaeVar, zzg zzgVar, List list, boolean z) {
        ...
        while ((i2 - i) * i3 >= 0) {
            if (zzaeVar.zzs(i)) {
                zzapVar = zzaiVar.zza(zzgVar, Arrays.asList(new zzap[]{zzapVar, zzaeVar.zze(i), new zzah(Double.valueOf(i)), zzaeVar}));
                if (zzapVar instanceof zzag) {
