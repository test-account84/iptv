...
public final class zzhf implements zzhk {
            ...
            synchronized (this.zzg) {
                ...
                if (map2 == null) {
                    ...
                    try {
                        ...
                        } catch (SecurityException | SQLiteException | IllegalStateException unused) {
                            Log.e("ConfigurationContentLdr", "PhenotypeFlag unable to load ContentProvider, using default values");
                            StrictMode.setThreadPolicy(map2);
                            map = null;
                        }
                        this.zzh = map;
                        map2 = map;
    ...
    public final /* synthetic */ Map zzd() {
        ...
        try {
            ...
            s.a aVar = count <= 256 ? new s.a(count) : new HashMap(count, 1.0f);
