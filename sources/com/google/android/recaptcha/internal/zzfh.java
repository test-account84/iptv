...
final class zzfh extends zzfk {
    ...
    public zzfh(byte[] bArr, int i, int i2) {
        super(null);
        if (bArr == null) {
    ...
    public final void zze(int i, zzez zzezVar) throws IOException {
        zzq((i << 3) | 2);
        zzq(zzezVar.zzd());
        zzezVar.zzi(this);
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            if (zzy2 != zzy) {
                ...
                byte[] bArr = this.zzc;
                int i2 = this.zze;
                this.zze = zzju.zzb(str, bArr, i2, this.zzd - i2);
                return;
            }
            int i3 = i + zzy2;
            this.zze = i3;
            int zzb = zzju.zzb(str, this.zzc, i3, this.zzd - i3);
            this.zze = i;
            zzq((zzb - i) - zzy2);
            this.zze = zzb;
        } catch (zzjt e) {
    ...
    public final void zzs(long j) throws IOException {
        if (zzfk.zzD() && this.zzd - this.zze >= 10) {
            while ((j & (-128)) != 0) {
                ...
                int i = this.zze;
                this.zze = i + 1;
                zzjp.zzn(bArr, i, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr2 = this.zzc;
            int i2 = this.zze;
            this.zze = 1 + i2;
            zzjp.zzn(bArr2, i2, (byte) j);
            return;
        }
        while ((j & (-128)) != 0) {
            try {
