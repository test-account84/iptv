...
interface zzik {
    ...
    @Deprecated
    void zzC(List list, zzil zzilVar, zzfz zzfzVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzil zzilVar, zzfz zzfzVar) throws IOException;
    ...
    zzez zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzil zzilVar, zzfz zzfzVar) throws IOException;

    void zzu(Object obj, zzil zzilVar, zzfz zzfzVar) throws IOException;
