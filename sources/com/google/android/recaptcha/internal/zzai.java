...
public final class zzai {
    ...
    public static final void zza(@NotNull zzaf zzafVar, @Nullable Long l, int i) {
        ...
        if (zzahVar != null) {
            ...
            zzf.zze(i);
            if (l != null) {
                zzf.zzd(zzjy.zza(l.longValue() - zzahVar.zza()));
            }
    ...
    public static final void zzd(@NotNull zzaf zzafVar, @NotNull String str, int i, @NotNull Context context, @NotNull zzr zzrVar, @Nullable String str2) {
        zzkl zzg = zzkm.zzg();
        zzg.zzp(str);
        zzg.zzd(i);
        if (str2 != null) {
    ...
    private static final void zze(zzaf zzafVar, int i, zzkm zzkmVar, Context context, zzr zzrVar) {
        ...
        if (zzahVar != null) {
            zzkx zzc = zzahVar.zzc(i, zzkmVar, context);
            zzj zzjVar = zzj.zza;
