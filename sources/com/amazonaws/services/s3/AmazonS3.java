...
public interface AmazonS3 extends S3DirectSpi {
    ...
    List listBuckets() throws AmazonClientException, AmazonServiceException;

    List listBuckets(ListBucketsRequest listBucketsRequest) throws AmazonClientException, AmazonServiceException;
