...
public class AmazonS3EncryptionClient extends AmazonS3Client implements AmazonS3Encryption {
    ...
    public final class S3DirectImpl extends S3Direct {
        ...
        public void abortMultipartUpload(AbortMultipartUploadRequest abortMultipartUploadRequest) {
            AmazonS3EncryptionClient.access$801(AmazonS3EncryptionClient.this, abortMultipartUploadRequest);
        }

        public CompleteMultipartUploadResult completeMultipartUpload(CompleteMultipartUploadRequest completeMultipartUploadRequest) {
            return AmazonS3EncryptionClient.access$401(AmazonS3EncryptionClient.this, completeMultipartUploadRequest);
        }

        public CopyPartResult copyPart(CopyPartRequest copyPartRequest) {
            return AmazonS3EncryptionClient.access$701(AmazonS3EncryptionClient.this, copyPartRequest);
        }

        public ObjectMetadata getObject(GetObjectRequest getObjectRequest, File file) {
            return AmazonS3EncryptionClient.access$301(AmazonS3EncryptionClient.this, getObjectRequest, file);
        }
        ...
        public InitiateMultipartUploadResult initiateMultipartUpload(InitiateMultipartUploadRequest initiateMultipartUploadRequest) {
            return AmazonS3EncryptionClient.access$501(AmazonS3EncryptionClient.this, initiateMultipartUploadRequest);
        }

        public PutObjectResult putObject(PutObjectRequest putObjectRequest) {
            return AmazonS3EncryptionClient.access$101(AmazonS3EncryptionClient.this, putObjectRequest);
        }
        ...
        public UploadPartResult uploadPart(UploadPartRequest uploadPartRequest) throws AmazonClientException, AmazonServiceException {
            return AmazonS3EncryptionClient.access$601(AmazonS3EncryptionClient.this, uploadPartRequest);
        }

        public /* synthetic */ S3DirectImpl(AmazonS3EncryptionClient amazonS3EncryptionClient, 1 r2) {
            this();
        }

        public S3Object getObject(GetObjectRequest getObjectRequest) {
            return AmazonS3EncryptionClient.access$201(AmazonS3EncryptionClient.this, getObjectRequest);
        }
    }
    ...
    public static /* synthetic */ PutObjectResult access$101(AmazonS3EncryptionClient amazonS3EncryptionClient, PutObjectRequest putObjectRequest) throws AmazonClientException, AmazonServiceException {
        return super.putObject(putObjectRequest);
    }

    public static /* synthetic */ S3Object access$201(AmazonS3EncryptionClient amazonS3EncryptionClient, GetObjectRequest getObjectRequest) throws AmazonClientException, AmazonServiceException {
        return super.getObject(getObjectRequest);
    }

    public static /* synthetic */ ObjectMetadata access$301(AmazonS3EncryptionClient amazonS3EncryptionClient, GetObjectRequest getObjectRequest, File file) throws AmazonClientException, AmazonServiceException {
        return super.getObject(getObjectRequest, file);
    }

    public static /* synthetic */ CompleteMultipartUploadResult access$401(AmazonS3EncryptionClient amazonS3EncryptionClient, CompleteMultipartUploadRequest completeMultipartUploadRequest) throws AmazonClientException, AmazonServiceException {
        return super.completeMultipartUpload(completeMultipartUploadRequest);
    }

    public static /* synthetic */ InitiateMultipartUploadResult access$501(AmazonS3EncryptionClient amazonS3EncryptionClient, InitiateMultipartUploadRequest initiateMultipartUploadRequest) throws AmazonClientException, AmazonServiceException {
        return super.initiateMultipartUpload(initiateMultipartUploadRequest);
    }

    public static /* synthetic */ UploadPartResult access$601(AmazonS3EncryptionClient amazonS3EncryptionClient, UploadPartRequest uploadPartRequest) throws AmazonClientException, AmazonServiceException {
        return super.uploadPart(uploadPartRequest);
    }

    public static /* synthetic */ CopyPartResult access$701(AmazonS3EncryptionClient amazonS3EncryptionClient, CopyPartRequest copyPartRequest) {
        return super.copyPart(copyPartRequest);
    }

    public static /* synthetic */ void access$801(AmazonS3EncryptionClient amazonS3EncryptionClient, AbortMultipartUploadRequest abortMultipartUploadRequest) throws AmazonClientException, AmazonServiceException {
    ...
    public InitiateMultipartUploadResult initiateMultipartUpload(InitiateMultipartUploadRequest initiateMultipartUploadRequest) {
        return initiateMultipartUploadRequest instanceof EncryptedInitiateMultipartUploadRequest ? ((EncryptedInitiateMultipartUploadRequest) initiateMultipartUploadRequest).isCreateEncryptionMaterial() : true ? this.crypto.initiateMultipartUploadSecurely(initiateMultipartUploadRequest) : super.initiateMultipartUpload(initiateMultipartUploadRequest);
    }
    ...
    public CompleteMultipartUploadResult uploadObject(UploadObjectRequest uploadObjectRequest) throws IOException, InterruptedException, ExecutionException {
        ...
        uploadObjectObserver.init(uploadObjectRequest, new S3DirectImpl(this, null), this, executorService);
            ...
            try {
                try {
                    try {
                        ...
                        Iterator it = uploadObjectObserver.getFutures().iterator();
                        while (it.hasNext()) {
                    ...
                    throw onAbort(uploadObjectObserver, e2);
                } catch (IOException e3) {
                    throw onAbort(uploadObjectObserver, e3);
                }
            } catch (Error e4) {
                throw onAbort(uploadObjectObserver, e4);
            } catch (RuntimeException e5) {
                throw onAbort(uploadObjectObserver, e5);
            }
        } catch (Throwable th) {
            if (z) {
                executorService.shutdownNow();
    ...
    public AmazonS3EncryptionClient(AWSKMSClient aWSKMSClient, AWSCredentialsProvider aWSCredentialsProvider, EncryptionMaterialsProvider encryptionMaterialsProvider, ClientConfiguration clientConfiguration, CryptoConfiguration cryptoConfiguration, RequestMetricCollector requestMetricCollector) {
        ...
        this.crypto = new CryptoModuleDispatcher(newAWSKMSClient, new S3DirectImpl(this, null), aWSCredentialsProvider, encryptionMaterialsProvider, cryptoConfiguration);
    }
