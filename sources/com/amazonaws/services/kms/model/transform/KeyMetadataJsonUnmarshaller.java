...
class KeyMetadataJsonUnmarshaller implements Unmarshaller {
    ...
    public KeyMetadata unmarshall(JsonUnmarshallerContext jsonUnmarshallerContext) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            } else if (nextName.equals("MacAlgorithms")) {
                keyMetadata.setMacAlgorithms(new ListUnmarshaller(SimpleTypeJsonUnmarshallers.StringJsonUnmarshaller.getInstance()).unmarshall(jsonUnmarshallerContext));
            } else {
                reader.skipValue();
            }
        }
