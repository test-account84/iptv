...
public class GenerateDataKeyPairRequestMarshaller implements Marshaller {
    public Request marshall(GenerateDataKeyPairRequest generateDataKeyPairRequest) {
        ...
        try {
            ...
            if (generateDataKeyPairRequest.getEncryptionContext() != null) {
                Map encryptionContext = generateDataKeyPairRequest.getEncryptionContext();
