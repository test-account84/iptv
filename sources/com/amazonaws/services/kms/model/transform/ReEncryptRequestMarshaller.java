...
public class ReEncryptRequestMarshaller implements Marshaller {
    public Request marshall(ReEncryptRequest reEncryptRequest) {
        ...
        try {
            ...
            if (reEncryptRequest.getSourceEncryptionContext() != null) {
                Map sourceEncryptionContext = reEncryptRequest.getSourceEncryptionContext();
                jsonWriter.name("SourceEncryptionContext");
                jsonWriter.beginObject();
                for (Map.Entry entry : sourceEncryptionContext.entrySet()) {
            ...
            if (reEncryptRequest.getDestinationEncryptionContext() != null) {
                Map destinationEncryptionContext = reEncryptRequest.getDestinationEncryptionContext();
                jsonWriter.name("DestinationEncryptionContext");
                jsonWriter.beginObject();
                for (Map.Entry entry2 : destinationEncryptionContext.entrySet()) {
