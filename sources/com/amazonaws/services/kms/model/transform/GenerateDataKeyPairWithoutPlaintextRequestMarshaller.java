...
public class GenerateDataKeyPairWithoutPlaintextRequestMarshaller implements Marshaller {
    public Request marshall(GenerateDataKeyPairWithoutPlaintextRequest generateDataKeyPairWithoutPlaintextRequest) {
        ...
        try {
            ...
            if (generateDataKeyPairWithoutPlaintextRequest.getEncryptionContext() != null) {
                Map encryptionContext = generateDataKeyPairWithoutPlaintextRequest.getEncryptionContext();
