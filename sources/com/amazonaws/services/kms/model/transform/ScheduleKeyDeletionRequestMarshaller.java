...
public class ScheduleKeyDeletionRequestMarshaller implements Marshaller {
    public Request marshall(ScheduleKeyDeletionRequest scheduleKeyDeletionRequest) {
        ...
        try {
            ...
            if (scheduleKeyDeletionRequest.getPendingWindowInDays() != null) {
                ...
                jsonWriter.value((Number) pendingWindowInDays);
            }
