...
public class GenerateDataKeyWithoutPlaintextRequestMarshaller implements Marshaller {
    public Request marshall(GenerateDataKeyWithoutPlaintextRequest generateDataKeyWithoutPlaintextRequest) {
        ...
        try {
            ...
            if (generateDataKeyWithoutPlaintextRequest.getEncryptionContext() != null) {
                Map encryptionContext = generateDataKeyWithoutPlaintextRequest.getEncryptionContext();
