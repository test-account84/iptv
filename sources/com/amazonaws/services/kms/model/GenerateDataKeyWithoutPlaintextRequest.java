...
public class GenerateDataKeyWithoutPlaintextRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public GenerateDataKeyWithoutPlaintextRequest withEncryptionContext(Map map) {
        this.encryptionContext = map;
        return this;
    }

    public GenerateDataKeyWithoutPlaintextRequest withGrantTokens(Collection collection) {
