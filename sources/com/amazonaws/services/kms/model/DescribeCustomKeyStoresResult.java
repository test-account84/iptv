...
public class DescribeCustomKeyStoresResult implements Serializable {
    private List customKeyStores = new ArrayList();
    ...
    public List getCustomKeyStores() {
    ...
    public void setCustomKeyStores(Collection collection) {
        if (collection == null) {
    ...
    public DescribeCustomKeyStoresResult withCustomKeyStores(Collection collection) {
