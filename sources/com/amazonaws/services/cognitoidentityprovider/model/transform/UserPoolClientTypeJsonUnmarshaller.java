...
class UserPoolClientTypeJsonUnmarshaller implements Unmarshaller {
    ...
    public UserPoolClientType unmarshall(JsonUnmarshallerContext jsonUnmarshallerContext) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            } else if (nextName.equals("EnablePropagateAdditionalUserContextData")) {
            ...
            } else if (nextName.equals("AuthSessionValidity")) {
