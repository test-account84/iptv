...
public class AdminUpdateUserAttributesRequestMarshaller implements Marshaller {
    public Request marshall(AdminUpdateUserAttributesRequest adminUpdateUserAttributesRequest) {
        ...
        try {
            ...
            if (adminUpdateUserAttributesRequest.getClientMetadata() != null) {
                Map clientMetadata = adminUpdateUserAttributesRequest.getClientMetadata();
