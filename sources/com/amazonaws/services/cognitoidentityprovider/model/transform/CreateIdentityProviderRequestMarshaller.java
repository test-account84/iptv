...
public class CreateIdentityProviderRequestMarshaller implements Marshaller {
    public Request marshall(CreateIdentityProviderRequest createIdentityProviderRequest) {
        ...
        try {
            ...
            if (createIdentityProviderRequest.getProviderDetails() != null) {
                Map providerDetails = createIdentityProviderRequest.getProviderDetails();
            ...
            if (createIdentityProviderRequest.getAttributeMapping() != null) {
                Map attributeMapping = createIdentityProviderRequest.getAttributeMapping();
