...
public class ConfirmSignUpRequestMarshaller implements Marshaller {
    public Request marshall(ConfirmSignUpRequest confirmSignUpRequest) {
        ...
        try {
            ...
            if (confirmSignUpRequest.getClientMetadata() != null) {
                Map clientMetadata = confirmSignUpRequest.getClientMetadata();
