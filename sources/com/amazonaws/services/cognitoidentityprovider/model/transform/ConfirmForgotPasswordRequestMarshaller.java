...
public class ConfirmForgotPasswordRequestMarshaller implements Marshaller {
    public Request marshall(ConfirmForgotPasswordRequest confirmForgotPasswordRequest) {
        ...
        try {
            ...
            if (confirmForgotPasswordRequest.getClientMetadata() != null) {
                Map clientMetadata = confirmForgotPasswordRequest.getClientMetadata();
