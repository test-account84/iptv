...
public class ForgotPasswordRequestMarshaller implements Marshaller {
    public Request marshall(ForgotPasswordRequest forgotPasswordRequest) {
        ...
        try {
            ...
            if (forgotPasswordRequest.getClientMetadata() != null) {
                Map clientMetadata = forgotPasswordRequest.getClientMetadata();
