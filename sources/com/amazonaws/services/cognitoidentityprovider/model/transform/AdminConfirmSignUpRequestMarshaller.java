...
public class AdminConfirmSignUpRequestMarshaller implements Marshaller {
    public Request marshall(AdminConfirmSignUpRequest adminConfirmSignUpRequest) {
        ...
        try {
            ...
            if (adminConfirmSignUpRequest.getClientMetadata() != null) {
                Map clientMetadata = adminConfirmSignUpRequest.getClientMetadata();
