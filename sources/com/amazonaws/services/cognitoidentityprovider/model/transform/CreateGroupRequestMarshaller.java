...
public class CreateGroupRequestMarshaller implements Marshaller {
    public Request marshall(CreateGroupRequest createGroupRequest) {
        ...
        try {
            ...
            if (createGroupRequest.getPrecedence() != null) {
                ...
                jsonWriter.value((Number) precedence);
            }
