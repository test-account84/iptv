...
class UserPoolTypeJsonUnmarshaller implements Unmarshaller {
    ...
    public UserPoolType unmarshall(JsonUnmarshallerContext jsonUnmarshallerContext) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            } else if (nextName.equals("DeletionProtection")) {
            ...
            } else if (nextName.equals("UserAttributeUpdateSettings")) {
