...
public class RespondToAuthChallengeRequestMarshaller implements Marshaller {
    public Request marshall(RespondToAuthChallengeRequest respondToAuthChallengeRequest) {
        ...
        try {
            ...
            if (respondToAuthChallengeRequest.getChallengeResponses() != null) {
                Map challengeResponses = respondToAuthChallengeRequest.getChallengeResponses();
            ...
            if (respondToAuthChallengeRequest.getClientMetadata() != null) {
                Map clientMetadata = respondToAuthChallengeRequest.getClientMetadata();
