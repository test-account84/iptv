...
public class AdminCreateUserRequestMarshaller implements Marshaller {
    public Request marshall(AdminCreateUserRequest adminCreateUserRequest) {
        ...
        try {
            ...
            if (adminCreateUserRequest.getClientMetadata() != null) {
                Map clientMetadata = adminCreateUserRequest.getClientMetadata();
