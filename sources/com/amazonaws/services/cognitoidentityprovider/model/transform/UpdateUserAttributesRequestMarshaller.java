...
public class UpdateUserAttributesRequestMarshaller implements Marshaller {
    public Request marshall(UpdateUserAttributesRequest updateUserAttributesRequest) {
        ...
        try {
            ...
            if (updateUserAttributesRequest.getClientMetadata() != null) {
                Map clientMetadata = updateUserAttributesRequest.getClientMetadata();
