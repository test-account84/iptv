...
public class AdminRespondToAuthChallengeRequestMarshaller implements Marshaller {
    public Request marshall(AdminRespondToAuthChallengeRequest adminRespondToAuthChallengeRequest) {
        ...
        try {
            ...
            if (adminRespondToAuthChallengeRequest.getChallengeResponses() != null) {
                Map challengeResponses = adminRespondToAuthChallengeRequest.getChallengeResponses();
                jsonWriter.name("ChallengeResponses");
                jsonWriter.beginObject();
                for (Map.Entry entry : challengeResponses.entrySet()) {
            ...
            if (adminRespondToAuthChallengeRequest.getClientMetadata() != null) {
                Map clientMetadata = adminRespondToAuthChallengeRequest.getClientMetadata();
