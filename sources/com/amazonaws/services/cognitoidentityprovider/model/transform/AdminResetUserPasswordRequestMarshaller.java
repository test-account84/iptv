...
public class AdminResetUserPasswordRequestMarshaller implements Marshaller {
    public Request marshall(AdminResetUserPasswordRequest adminResetUserPasswordRequest) {
        ...
        try {
            ...
            if (adminResetUserPasswordRequest.getClientMetadata() != null) {
                Map clientMetadata = adminResetUserPasswordRequest.getClientMetadata();
