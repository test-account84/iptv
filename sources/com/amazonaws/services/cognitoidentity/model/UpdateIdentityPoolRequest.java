...
public class UpdateIdentityPoolRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public UpdateIdentityPoolRequest withCognitoIdentityProviders(Collection collection) {
    ...
    public UpdateIdentityPoolRequest withIdentityPoolTags(Map map) {
        this.identityPoolTags = map;
        return this;
    }

    public UpdateIdentityPoolRequest withOpenIdConnectProviderARNs(Collection collection) {
        setOpenIdConnectProviderARNs(collection);
        return this;
    }

    public UpdateIdentityPoolRequest withSamlProviderARNs(Collection collection) {
        setSamlProviderARNs(collection);
        return this;
    }

    public UpdateIdentityPoolRequest withSupportedLoginProviders(Map map) {
        this.supportedLoginProviders = map;
        return this;
    }
