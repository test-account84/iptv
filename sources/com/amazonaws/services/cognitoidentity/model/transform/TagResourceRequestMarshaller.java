...
public class TagResourceRequestMarshaller implements Marshaller {
    public Request marshall(TagResourceRequest tagResourceRequest) {
        ...
        try {
            ...
            if (tagResourceRequest.getTags() != null) {
                Map tags = tagResourceRequest.getTags();
