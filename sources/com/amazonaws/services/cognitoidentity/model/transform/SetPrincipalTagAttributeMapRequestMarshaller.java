...
public class SetPrincipalTagAttributeMapRequestMarshaller implements Marshaller {
    public Request marshall(SetPrincipalTagAttributeMapRequest setPrincipalTagAttributeMapRequest) {
        ...
        try {
            ...
            if (setPrincipalTagAttributeMapRequest.getPrincipalTags() != null) {
                Map principalTags = setPrincipalTagAttributeMapRequest.getPrincipalTags();
                jsonWriter.name("PrincipalTags");
                jsonWriter.beginObject();
                for (Map.Entry entry : principalTags.entrySet()) {
