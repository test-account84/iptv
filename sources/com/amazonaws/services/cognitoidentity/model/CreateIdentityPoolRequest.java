...
public class CreateIdentityPoolRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public CreateIdentityPoolRequest withCognitoIdentityProviders(Collection collection) {
    ...
    public CreateIdentityPoolRequest withIdentityPoolTags(Map map) {
        this.identityPoolTags = map;
        return this;
    }

    public CreateIdentityPoolRequest withOpenIdConnectProviderARNs(Collection collection) {
        setOpenIdConnectProviderARNs(collection);
        return this;
    }

    public CreateIdentityPoolRequest withSamlProviderARNs(Collection collection) {
        setSamlProviderARNs(collection);
        return this;
    }

    public CreateIdentityPoolRequest withSupportedLoginProviders(Map map) {
        this.supportedLoginProviders = map;
        return this;
    }
