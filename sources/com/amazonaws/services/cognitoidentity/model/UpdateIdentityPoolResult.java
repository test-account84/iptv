...
public class UpdateIdentityPoolResult implements Serializable {
    ...
    public UpdateIdentityPoolResult withCognitoIdentityProviders(Collection collection) {
    ...
    public UpdateIdentityPoolResult withIdentityPoolTags(Map map) {
        this.identityPoolTags = map;
        return this;
    }

    public UpdateIdentityPoolResult withOpenIdConnectProviderARNs(Collection collection) {
        setOpenIdConnectProviderARNs(collection);
        return this;
    }

    public UpdateIdentityPoolResult withSamlProviderARNs(Collection collection) {
        setSamlProviderARNs(collection);
        return this;
    }

    public UpdateIdentityPoolResult withSupportedLoginProviders(Map map) {
        this.supportedLoginProviders = map;
        return this;
    }
