...
public final class DeleteSmartersNewMutation implements e {
    public static final String OPERATION_DEFINITION = "mutation DeleteSmartersNew($input: DeleteSmartersNewInput!, $condition: ModelSmartersNewConditionInput) {\n  deleteSmartersNew(input: $input, condition: $condition) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    private static final g OPERATION_NAME = new 1();
    public static final String QUERY_DOCUMENT = "mutation DeleteSmartersNew($input: DeleteSmartersNewInput!, $condition: ModelSmartersNewConditionInput) {\n  deleteSmartersNew(input: $input, condition: $condition) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    private final Variables variables;

    public class 1 implements g {
        public String name() {
            return "DeleteSmartersNew";
        }
    }

    public static class Data implements f.a {
        static final k[] $responseFields = {k.f("deleteSmartersNew", "deleteSmartersNew", new x1.f(2).b("input", new x1.f(2).b("kind", "Variable").b("variableName", "input").a()).b("condition", new x1.f(2).b("kind", "Variable").b("variableName", "condition").a()).a(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteSmartersNew deleteSmartersNew;
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                ...
                DeleteSmartersNew deleteSmartersNew = Data.this.deleteSmartersNew;
                oVar.d(kVar, deleteSmartersNew != null ? deleteSmartersNew.marshaller() : null);
            }
        }

        public static final class Mapper implements l {
            final DeleteSmartersNew.Mapper deleteSmartersNewFieldMapper = new DeleteSmartersNew.Mapper();

            public class 1 implements n.c {
                public 1() {
                }

                public DeleteSmartersNew read(n nVar) {
                    return Mapper.this.deleteSmartersNewFieldMapper.map(nVar);
                }
            }

            public Data map(n nVar) {
                return new Data((DeleteSmartersNew) nVar.b(Data.$responseFields[0], new 1()));
            }
        }

        public Data(DeleteSmartersNew deleteSmartersNew) {
            this.deleteSmartersNew = deleteSmartersNew;
        }

        public DeleteSmartersNew deleteSmartersNew() {
            return this.deleteSmartersNew;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteSmartersNew deleteSmartersNew = this.deleteSmartersNew;
            DeleteSmartersNew deleteSmartersNew2 = ((Data) obj).deleteSmartersNew;
            return deleteSmartersNew == null ? deleteSmartersNew2 == null : deleteSmartersNew.equals(deleteSmartersNew2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteSmartersNew deleteSmartersNew = this.deleteSmartersNew;
                this.$hashCode = (deleteSmartersNew == null ? 0 : deleteSmartersNew.hashCode()) ^ 1000003;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteSmartersNew=" + this.deleteSmartersNew + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteSmartersNew {
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                k[] kVarArr = DeleteSmartersNew.$responseFields;
                oVar.b(kVarArr[0], DeleteSmartersNew.this.__typename);
                oVar.c((k.a) kVarArr[1], DeleteSmartersNew.this.id);
                oVar.b(kVarArr[2], DeleteSmartersNew.this.config1);
                oVar.b(kVarArr[3], DeleteSmartersNew.this.config2);
                oVar.b(kVarArr[4], DeleteSmartersNew.this.config3);
                oVar.b(kVarArr[5], DeleteSmartersNew.this.config4);
                oVar.b(kVarArr[6], DeleteSmartersNew.this.config5);
                oVar.b(kVarArr[7], DeleteSmartersNew.this.config6);
                oVar.b(kVarArr[8], DeleteSmartersNew.this.config7);
                oVar.b(kVarArr[9], DeleteSmartersNew.this.config8);
                oVar.b(kVarArr[10], DeleteSmartersNew.this.config9);
                oVar.b(kVarArr[11], DeleteSmartersNew.this.config10);
                oVar.b(kVarArr[12], DeleteSmartersNew.this.config11);
                oVar.b(kVarArr[13], DeleteSmartersNew.this.config12);
                oVar.b(kVarArr[14], DeleteSmartersNew.this.config13);
                oVar.b(kVarArr[15], DeleteSmartersNew.this.config14);
                oVar.b(kVarArr[16], DeleteSmartersNew.this.config15);
                oVar.b(kVarArr[17], DeleteSmartersNew.this.config16);
                oVar.b(kVarArr[18], DeleteSmartersNew.this.config17);
                oVar.b(kVarArr[19], DeleteSmartersNew.this.config18);
                oVar.b(kVarArr[20], DeleteSmartersNew.this.config19);
                oVar.b(kVarArr[21], DeleteSmartersNew.this.config20);
                oVar.b(kVarArr[22], DeleteSmartersNew.this.config21);
                oVar.b(kVarArr[23], DeleteSmartersNew.this.config22);
                oVar.b(kVarArr[24], DeleteSmartersNew.this.config23);
                oVar.b(kVarArr[25], DeleteSmartersNew.this.config24);
                oVar.b(kVarArr[26], DeleteSmartersNew.this.config25);
                oVar.b(kVarArr[27], DeleteSmartersNew.this.config26);
                oVar.b(kVarArr[28], DeleteSmartersNew.this.config27);
                oVar.b(kVarArr[29], DeleteSmartersNew.this.config28);
                oVar.b(kVarArr[30], DeleteSmartersNew.this.config29);
                oVar.b(kVarArr[31], DeleteSmartersNew.this.config30);
                oVar.b(kVarArr[32], DeleteSmartersNew.this.config31);
                oVar.b(kVarArr[33], DeleteSmartersNew.this.config32);
                oVar.b(kVarArr[34], DeleteSmartersNew.this.config33);
                oVar.b(kVarArr[35], DeleteSmartersNew.this.config34);
                oVar.b(kVarArr[36], DeleteSmartersNew.this.config35);
                oVar.c((k.a) kVarArr[37], DeleteSmartersNew.this.createdAt);
                oVar.c((k.a) kVarArr[38], DeleteSmartersNew.this.updatedAt);
            }
        }

        public static final class Mapper implements l {
            public DeleteSmartersNew map(n nVar) {
                k[] kVarArr = DeleteSmartersNew.$responseFields;
                return new DeleteSmartersNew(nVar.c(kVarArr[0]), (String) nVar.d((k.a) kVarArr[1]), nVar.c(kVarArr[2]), nVar.c(kVarArr[3]), nVar.c(kVarArr[4]), nVar.c(kVarArr[5]), nVar.c(kVarArr[6]), nVar.c(kVarArr[7]), nVar.c(kVarArr[8]), nVar.c(kVarArr[9]), nVar.c(kVarArr[10]), nVar.c(kVarArr[11]), nVar.c(kVarArr[12]), nVar.c(kVarArr[13]), nVar.c(kVarArr[14]), nVar.c(kVarArr[15]), nVar.c(kVarArr[16]), nVar.c(kVarArr[17]), nVar.c(kVarArr[18]), nVar.c(kVarArr[19]), nVar.c(kVarArr[20]), nVar.c(kVarArr[21]), nVar.c(kVarArr[22]), nVar.c(kVarArr[23]), nVar.c(kVarArr[24]), nVar.c(kVarArr[25]), nVar.c(kVarArr[26]), nVar.c(kVarArr[27]), nVar.c(kVarArr[28]), nVar.c(kVarArr[29]), nVar.c(kVarArr[30]), nVar.c(kVarArr[31]), nVar.c(kVarArr[32]), nVar.c(kVarArr[33]), nVar.c(kVarArr[34]), nVar.c(kVarArr[35]), nVar.c(kVarArr[36]), (String) nVar.d((k.a) kVarArr[37]), (String) nVar.d((k.a) kVarArr[38]));
            }
        }
        ...
        public DeleteSmartersNew(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20, String str21, String str22, String str23, String str24, String str25, String str26, String str27, String str28, String str29, String str30, String str31, String str32, String str33, String str34, String str35, String str36, String str37, String str38, String str39) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteSmartersNew)) {
                return false;
            }
            DeleteSmartersNew deleteSmartersNew = (DeleteSmartersNew) obj;
            return this.__typename.equals(deleteSmartersNew.__typename) && this.id.equals(deleteSmartersNew.id) && this.config1.equals(deleteSmartersNew.config1) && this.config2.equals(deleteSmartersNew.config2) && this.config3.equals(deleteSmartersNew.config3) && this.config4.equals(deleteSmartersNew.config4) && this.config5.equals(deleteSmartersNew.config5) && this.config6.equals(deleteSmartersNew.config6) && this.config7.equals(deleteSmartersNew.config7) && this.config8.equals(deleteSmartersNew.config8) && this.config9.equals(deleteSmartersNew.config9) && this.config10.equals(deleteSmartersNew.config10) && this.config11.equals(deleteSmartersNew.config11) && this.config12.equals(deleteSmartersNew.config12) && this.config13.equals(deleteSmartersNew.config13) && this.config14.equals(deleteSmartersNew.config14) && this.config15.equals(deleteSmartersNew.config15) && this.config16.equals(deleteSmartersNew.config16) && this.config17.equals(deleteSmartersNew.config17) && this.config18.equals(deleteSmartersNew.config18) && this.config19.equals(deleteSmartersNew.config19) && this.config20.equals(deleteSmartersNew.config20) && this.config21.equals(deleteSmartersNew.config21) && this.config22.equals(deleteSmartersNew.config22) && this.config23.equals(deleteSmartersNew.config23) && this.config24.equals(deleteSmartersNew.config24) && this.config25.equals(deleteSmartersNew.config25) && this.config26.equals(deleteSmartersNew.config26) && this.config27.equals(deleteSmartersNew.config27) && this.config28.equals(deleteSmartersNew.config28) && this.config29.equals(deleteSmartersNew.config29) && this.config30.equals(deleteSmartersNew.config30) && this.config31.equals(deleteSmartersNew.config31) && this.config32.equals(deleteSmartersNew.config32) && this.config33.equals(deleteSmartersNew.config33) && this.config34.equals(deleteSmartersNew.config34) && this.config35.equals(deleteSmartersNew.config35) && this.createdAt.equals(deleteSmartersNew.createdAt) && this.updatedAt.equals(deleteSmartersNew.updatedAt);
        }
    ...
    public static final class Variables extends f.b {
        ...
        public class 1 implements v1.c {
            public 1() {
            }
        ...
        public static /* synthetic */ c access$000(Variables variables) {
            variables.getClass();
            return null;
        }
    ...
    public DeleteSmartersNewMutation(c cVar, d dVar) {
        x1.g.c(cVar, "input == null");
    ...
    public String operationId() {
        return "7a3503dddc70657b13445d9ff089be94ac2316247a10083be636cc6b27988bc8";
    }

    public String queryDocument() {
        return "mutation DeleteSmartersNew($input: DeleteSmartersNewInput!, $condition: ModelSmartersNewConditionInput) {\n  deleteSmartersNew(input: $input, condition: $condition) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    }
    ...
    public static final class Builder {
        ...
        public DeleteSmartersNewMutation build() {
            x1.g.c(null, "input == null");
            return new DeleteSmartersNewMutation(null, null);
        }
