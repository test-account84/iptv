...
public final class OnUpdateSmartersNewSubscription implements t {
    public static final String OPERATION_DEFINITION = "subscription OnUpdateSmartersNew($filter: ModelSubscriptionSmartersNewFilterInput) {\n  onUpdateSmartersNew(filter: $filter) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    private static final g OPERATION_NAME = new 1();
    public static final String QUERY_DOCUMENT = "subscription OnUpdateSmartersNew($filter: ModelSubscriptionSmartersNewFilterInput) {\n  onUpdateSmartersNew(filter: $filter) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    private final Variables variables;

    public class 1 implements g {
        public String name() {
            return "OnUpdateSmartersNew";
        }
    }

    public static class Data implements f.a {
        static final k[] $responseFields = {k.f("onUpdateSmartersNew", "onUpdateSmartersNew", new x1.f(1).b("filter", new x1.f(2).b("kind", "Variable").b("variableName", "filter").a()).a(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnUpdateSmartersNew onUpdateSmartersNew;
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                ...
                OnUpdateSmartersNew onUpdateSmartersNew = Data.this.onUpdateSmartersNew;
                oVar.d(kVar, onUpdateSmartersNew != null ? onUpdateSmartersNew.marshaller() : null);
            }
        }

        public static final class Mapper implements l {
            final OnUpdateSmartersNew.Mapper onUpdateSmartersNewFieldMapper = new OnUpdateSmartersNew.Mapper();

            public class 1 implements n.c {
                public 1() {
                }

                public OnUpdateSmartersNew read(n nVar) {
                    return Mapper.this.onUpdateSmartersNewFieldMapper.map(nVar);
                }
            }

            public Data map(n nVar) {
                return new Data((OnUpdateSmartersNew) nVar.b(Data.$responseFields[0], new 1()));
            }
        }

        public Data(OnUpdateSmartersNew onUpdateSmartersNew) {
            this.onUpdateSmartersNew = onUpdateSmartersNew;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnUpdateSmartersNew onUpdateSmartersNew = this.onUpdateSmartersNew;
            OnUpdateSmartersNew onUpdateSmartersNew2 = ((Data) obj).onUpdateSmartersNew;
            return onUpdateSmartersNew == null ? onUpdateSmartersNew2 == null : onUpdateSmartersNew.equals(onUpdateSmartersNew2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnUpdateSmartersNew onUpdateSmartersNew = this.onUpdateSmartersNew;
                this.$hashCode = (onUpdateSmartersNew == null ? 0 : onUpdateSmartersNew.hashCode()) ^ 1000003;
        ...
        public OnUpdateSmartersNew onUpdateSmartersNew() {
            return this.onUpdateSmartersNew;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onUpdateSmartersNew=" + this.onUpdateSmartersNew + "}";
            }
            return this.$toString;
        }
    }

    public static class OnUpdateSmartersNew {
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                k[] kVarArr = OnUpdateSmartersNew.$responseFields;
                oVar.b(kVarArr[0], OnUpdateSmartersNew.this.__typename);
                oVar.c((k.a) kVarArr[1], OnUpdateSmartersNew.this.id);
                oVar.b(kVarArr[2], OnUpdateSmartersNew.this.config1);
                oVar.b(kVarArr[3], OnUpdateSmartersNew.this.config2);
                oVar.b(kVarArr[4], OnUpdateSmartersNew.this.config3);
                oVar.b(kVarArr[5], OnUpdateSmartersNew.this.config4);
                oVar.b(kVarArr[6], OnUpdateSmartersNew.this.config5);
                oVar.b(kVarArr[7], OnUpdateSmartersNew.this.config6);
                oVar.b(kVarArr[8], OnUpdateSmartersNew.this.config7);
                oVar.b(kVarArr[9], OnUpdateSmartersNew.this.config8);
                oVar.b(kVarArr[10], OnUpdateSmartersNew.this.config9);
                oVar.b(kVarArr[11], OnUpdateSmartersNew.this.config10);
                oVar.b(kVarArr[12], OnUpdateSmartersNew.this.config11);
                oVar.b(kVarArr[13], OnUpdateSmartersNew.this.config12);
                oVar.b(kVarArr[14], OnUpdateSmartersNew.this.config13);
                oVar.b(kVarArr[15], OnUpdateSmartersNew.this.config14);
                oVar.b(kVarArr[16], OnUpdateSmartersNew.this.config15);
                oVar.b(kVarArr[17], OnUpdateSmartersNew.this.config16);
                oVar.b(kVarArr[18], OnUpdateSmartersNew.this.config17);
                oVar.b(kVarArr[19], OnUpdateSmartersNew.this.config18);
                oVar.b(kVarArr[20], OnUpdateSmartersNew.this.config19);
                oVar.b(kVarArr[21], OnUpdateSmartersNew.this.config20);
                oVar.b(kVarArr[22], OnUpdateSmartersNew.this.config21);
                oVar.b(kVarArr[23], OnUpdateSmartersNew.this.config22);
                oVar.b(kVarArr[24], OnUpdateSmartersNew.this.config23);
                oVar.b(kVarArr[25], OnUpdateSmartersNew.this.config24);
                oVar.b(kVarArr[26], OnUpdateSmartersNew.this.config25);
                oVar.b(kVarArr[27], OnUpdateSmartersNew.this.config26);
                oVar.b(kVarArr[28], OnUpdateSmartersNew.this.config27);
                oVar.b(kVarArr[29], OnUpdateSmartersNew.this.config28);
                oVar.b(kVarArr[30], OnUpdateSmartersNew.this.config29);
                oVar.b(kVarArr[31], OnUpdateSmartersNew.this.config30);
                oVar.b(kVarArr[32], OnUpdateSmartersNew.this.config31);
                oVar.b(kVarArr[33], OnUpdateSmartersNew.this.config32);
                oVar.b(kVarArr[34], OnUpdateSmartersNew.this.config33);
                oVar.b(kVarArr[35], OnUpdateSmartersNew.this.config34);
                oVar.b(kVarArr[36], OnUpdateSmartersNew.this.config35);
                oVar.c((k.a) kVarArr[37], OnUpdateSmartersNew.this.createdAt);
                oVar.c((k.a) kVarArr[38], OnUpdateSmartersNew.this.updatedAt);
            }
        }

        public static final class Mapper implements l {
            public OnUpdateSmartersNew map(n nVar) {
                k[] kVarArr = OnUpdateSmartersNew.$responseFields;
                return new OnUpdateSmartersNew(nVar.c(kVarArr[0]), (String) nVar.d((k.a) kVarArr[1]), nVar.c(kVarArr[2]), nVar.c(kVarArr[3]), nVar.c(kVarArr[4]), nVar.c(kVarArr[5]), nVar.c(kVarArr[6]), nVar.c(kVarArr[7]), nVar.c(kVarArr[8]), nVar.c(kVarArr[9]), nVar.c(kVarArr[10]), nVar.c(kVarArr[11]), nVar.c(kVarArr[12]), nVar.c(kVarArr[13]), nVar.c(kVarArr[14]), nVar.c(kVarArr[15]), nVar.c(kVarArr[16]), nVar.c(kVarArr[17]), nVar.c(kVarArr[18]), nVar.c(kVarArr[19]), nVar.c(kVarArr[20]), nVar.c(kVarArr[21]), nVar.c(kVarArr[22]), nVar.c(kVarArr[23]), nVar.c(kVarArr[24]), nVar.c(kVarArr[25]), nVar.c(kVarArr[26]), nVar.c(kVarArr[27]), nVar.c(kVarArr[28]), nVar.c(kVarArr[29]), nVar.c(kVarArr[30]), nVar.c(kVarArr[31]), nVar.c(kVarArr[32]), nVar.c(kVarArr[33]), nVar.c(kVarArr[34]), nVar.c(kVarArr[35]), nVar.c(kVarArr[36]), (String) nVar.d((k.a) kVarArr[37]), (String) nVar.d((k.a) kVarArr[38]));
            }
        }
        ...
        public OnUpdateSmartersNew(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20, String str21, String str22, String str23, String str24, String str25, String str26, String str27, String str28, String str29, String str30, String str31, String str32, String str33, String str34, String str35, String str36, String str37, String str38, String str39) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnUpdateSmartersNew)) {
                return false;
            }
            OnUpdateSmartersNew onUpdateSmartersNew = (OnUpdateSmartersNew) obj;
            return this.__typename.equals(onUpdateSmartersNew.__typename) && this.id.equals(onUpdateSmartersNew.id) && this.config1.equals(onUpdateSmartersNew.config1) && this.config2.equals(onUpdateSmartersNew.config2) && this.config3.equals(onUpdateSmartersNew.config3) && this.config4.equals(onUpdateSmartersNew.config4) && this.config5.equals(onUpdateSmartersNew.config5) && this.config6.equals(onUpdateSmartersNew.config6) && this.config7.equals(onUpdateSmartersNew.config7) && this.config8.equals(onUpdateSmartersNew.config8) && this.config9.equals(onUpdateSmartersNew.config9) && this.config10.equals(onUpdateSmartersNew.config10) && this.config11.equals(onUpdateSmartersNew.config11) && this.config12.equals(onUpdateSmartersNew.config12) && this.config13.equals(onUpdateSmartersNew.config13) && this.config14.equals(onUpdateSmartersNew.config14) && this.config15.equals(onUpdateSmartersNew.config15) && this.config16.equals(onUpdateSmartersNew.config16) && this.config17.equals(onUpdateSmartersNew.config17) && this.config18.equals(onUpdateSmartersNew.config18) && this.config19.equals(onUpdateSmartersNew.config19) && this.config20.equals(onUpdateSmartersNew.config20) && this.config21.equals(onUpdateSmartersNew.config21) && this.config22.equals(onUpdateSmartersNew.config22) && this.config23.equals(onUpdateSmartersNew.config23) && this.config24.equals(onUpdateSmartersNew.config24) && this.config25.equals(onUpdateSmartersNew.config25) && this.config26.equals(onUpdateSmartersNew.config26) && this.config27.equals(onUpdateSmartersNew.config27) && this.config28.equals(onUpdateSmartersNew.config28) && this.config29.equals(onUpdateSmartersNew.config29) && this.config30.equals(onUpdateSmartersNew.config30) && this.config31.equals(onUpdateSmartersNew.config31) && this.config32.equals(onUpdateSmartersNew.config32) && this.config33.equals(onUpdateSmartersNew.config33) && this.config34.equals(onUpdateSmartersNew.config34) && this.config35.equals(onUpdateSmartersNew.config35) && this.createdAt.equals(onUpdateSmartersNew.createdAt) && this.updatedAt.equals(onUpdateSmartersNew.updatedAt);
        }
    ...
    public OnUpdateSmartersNewSubscription(S8.f fVar) {
    ...
    public String operationId() {
        return "4d1067a6c2b391eb2654a63b149915d734b3b4b801760314b30fbaf7d2797c52";
    }

    public String queryDocument() {
        return "subscription OnUpdateSmartersNew($filter: ModelSubscriptionSmartersNewFilterInput) {\n  onUpdateSmartersNew(filter: $filter) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    }
    ...
    public static final class Builder {
        ...
        public OnUpdateSmartersNewSubscription build() {
            return new OnUpdateSmartersNewSubscription(null);
        }
