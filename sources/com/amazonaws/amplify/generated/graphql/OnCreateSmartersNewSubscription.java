...
public final class OnCreateSmartersNewSubscription implements t {
    public static final String OPERATION_DEFINITION = "subscription OnCreateSmartersNew($filter: ModelSubscriptionSmartersNewFilterInput) {\n  onCreateSmartersNew(filter: $filter) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    private static final g OPERATION_NAME = new 1();
    public static final String QUERY_DOCUMENT = "subscription OnCreateSmartersNew($filter: ModelSubscriptionSmartersNewFilterInput) {\n  onCreateSmartersNew(filter: $filter) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    private final Variables variables;

    public class 1 implements g {
        public String name() {
            return "OnCreateSmartersNew";
        }
    }

    public static class Data implements f.a {
        static final k[] $responseFields = {k.f("onCreateSmartersNew", "onCreateSmartersNew", new x1.f(1).b("filter", new x1.f(2).b("kind", "Variable").b("variableName", "filter").a()).a(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnCreateSmartersNew onCreateSmartersNew;
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                ...
                OnCreateSmartersNew onCreateSmartersNew = Data.this.onCreateSmartersNew;
                oVar.d(kVar, onCreateSmartersNew != null ? onCreateSmartersNew.marshaller() : null);
            }
        }

        public static final class Mapper implements l {
            final OnCreateSmartersNew.Mapper onCreateSmartersNewFieldMapper = new OnCreateSmartersNew.Mapper();

            public class 1 implements n.c {
                public 1() {
                }

                public OnCreateSmartersNew read(n nVar) {
                    return Mapper.this.onCreateSmartersNewFieldMapper.map(nVar);
                }
            }

            public Data map(n nVar) {
                return new Data((OnCreateSmartersNew) nVar.b(Data.$responseFields[0], new 1()));
            }
        }

        public Data(OnCreateSmartersNew onCreateSmartersNew) {
            this.onCreateSmartersNew = onCreateSmartersNew;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnCreateSmartersNew onCreateSmartersNew = this.onCreateSmartersNew;
            OnCreateSmartersNew onCreateSmartersNew2 = ((Data) obj).onCreateSmartersNew;
            return onCreateSmartersNew == null ? onCreateSmartersNew2 == null : onCreateSmartersNew.equals(onCreateSmartersNew2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnCreateSmartersNew onCreateSmartersNew = this.onCreateSmartersNew;
                this.$hashCode = (onCreateSmartersNew == null ? 0 : onCreateSmartersNew.hashCode()) ^ 1000003;
        ...
        public OnCreateSmartersNew onCreateSmartersNew() {
            return this.onCreateSmartersNew;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onCreateSmartersNew=" + this.onCreateSmartersNew + "}";
            }
            return this.$toString;
        }
    }

    public static class OnCreateSmartersNew {
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                k[] kVarArr = OnCreateSmartersNew.$responseFields;
                oVar.b(kVarArr[0], OnCreateSmartersNew.this.__typename);
                oVar.c((k.a) kVarArr[1], OnCreateSmartersNew.this.id);
                oVar.b(kVarArr[2], OnCreateSmartersNew.this.config1);
                oVar.b(kVarArr[3], OnCreateSmartersNew.this.config2);
                oVar.b(kVarArr[4], OnCreateSmartersNew.this.config3);
                oVar.b(kVarArr[5], OnCreateSmartersNew.this.config4);
                oVar.b(kVarArr[6], OnCreateSmartersNew.this.config5);
                oVar.b(kVarArr[7], OnCreateSmartersNew.this.config6);
                oVar.b(kVarArr[8], OnCreateSmartersNew.this.config7);
                oVar.b(kVarArr[9], OnCreateSmartersNew.this.config8);
                oVar.b(kVarArr[10], OnCreateSmartersNew.this.config9);
                oVar.b(kVarArr[11], OnCreateSmartersNew.this.config10);
                oVar.b(kVarArr[12], OnCreateSmartersNew.this.config11);
                oVar.b(kVarArr[13], OnCreateSmartersNew.this.config12);
                oVar.b(kVarArr[14], OnCreateSmartersNew.this.config13);
                oVar.b(kVarArr[15], OnCreateSmartersNew.this.config14);
                oVar.b(kVarArr[16], OnCreateSmartersNew.this.config15);
                oVar.b(kVarArr[17], OnCreateSmartersNew.this.config16);
                oVar.b(kVarArr[18], OnCreateSmartersNew.this.config17);
                oVar.b(kVarArr[19], OnCreateSmartersNew.this.config18);
                oVar.b(kVarArr[20], OnCreateSmartersNew.this.config19);
                oVar.b(kVarArr[21], OnCreateSmartersNew.this.config20);
                oVar.b(kVarArr[22], OnCreateSmartersNew.this.config21);
                oVar.b(kVarArr[23], OnCreateSmartersNew.this.config22);
                oVar.b(kVarArr[24], OnCreateSmartersNew.this.config23);
                oVar.b(kVarArr[25], OnCreateSmartersNew.this.config24);
                oVar.b(kVarArr[26], OnCreateSmartersNew.this.config25);
                oVar.b(kVarArr[27], OnCreateSmartersNew.this.config26);
                oVar.b(kVarArr[28], OnCreateSmartersNew.this.config27);
                oVar.b(kVarArr[29], OnCreateSmartersNew.this.config28);
                oVar.b(kVarArr[30], OnCreateSmartersNew.this.config29);
                oVar.b(kVarArr[31], OnCreateSmartersNew.this.config30);
                oVar.b(kVarArr[32], OnCreateSmartersNew.this.config31);
                oVar.b(kVarArr[33], OnCreateSmartersNew.this.config32);
                oVar.b(kVarArr[34], OnCreateSmartersNew.this.config33);
                oVar.b(kVarArr[35], OnCreateSmartersNew.this.config34);
                oVar.b(kVarArr[36], OnCreateSmartersNew.this.config35);
                oVar.c((k.a) kVarArr[37], OnCreateSmartersNew.this.createdAt);
                oVar.c((k.a) kVarArr[38], OnCreateSmartersNew.this.updatedAt);
            }
        }

        public static final class Mapper implements l {
            public OnCreateSmartersNew map(n nVar) {
                k[] kVarArr = OnCreateSmartersNew.$responseFields;
                return new OnCreateSmartersNew(nVar.c(kVarArr[0]), (String) nVar.d((k.a) kVarArr[1]), nVar.c(kVarArr[2]), nVar.c(kVarArr[3]), nVar.c(kVarArr[4]), nVar.c(kVarArr[5]), nVar.c(kVarArr[6]), nVar.c(kVarArr[7]), nVar.c(kVarArr[8]), nVar.c(kVarArr[9]), nVar.c(kVarArr[10]), nVar.c(kVarArr[11]), nVar.c(kVarArr[12]), nVar.c(kVarArr[13]), nVar.c(kVarArr[14]), nVar.c(kVarArr[15]), nVar.c(kVarArr[16]), nVar.c(kVarArr[17]), nVar.c(kVarArr[18]), nVar.c(kVarArr[19]), nVar.c(kVarArr[20]), nVar.c(kVarArr[21]), nVar.c(kVarArr[22]), nVar.c(kVarArr[23]), nVar.c(kVarArr[24]), nVar.c(kVarArr[25]), nVar.c(kVarArr[26]), nVar.c(kVarArr[27]), nVar.c(kVarArr[28]), nVar.c(kVarArr[29]), nVar.c(kVarArr[30]), nVar.c(kVarArr[31]), nVar.c(kVarArr[32]), nVar.c(kVarArr[33]), nVar.c(kVarArr[34]), nVar.c(kVarArr[35]), nVar.c(kVarArr[36]), (String) nVar.d((k.a) kVarArr[37]), (String) nVar.d((k.a) kVarArr[38]));
            }
        }
        ...
        public OnCreateSmartersNew(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20, String str21, String str22, String str23, String str24, String str25, String str26, String str27, String str28, String str29, String str30, String str31, String str32, String str33, String str34, String str35, String str36, String str37, String str38, String str39) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnCreateSmartersNew)) {
                return false;
            }
            OnCreateSmartersNew onCreateSmartersNew = (OnCreateSmartersNew) obj;
            return this.__typename.equals(onCreateSmartersNew.__typename) && this.id.equals(onCreateSmartersNew.id) && this.config1.equals(onCreateSmartersNew.config1) && this.config2.equals(onCreateSmartersNew.config2) && this.config3.equals(onCreateSmartersNew.config3) && this.config4.equals(onCreateSmartersNew.config4) && this.config5.equals(onCreateSmartersNew.config5) && this.config6.equals(onCreateSmartersNew.config6) && this.config7.equals(onCreateSmartersNew.config7) && this.config8.equals(onCreateSmartersNew.config8) && this.config9.equals(onCreateSmartersNew.config9) && this.config10.equals(onCreateSmartersNew.config10) && this.config11.equals(onCreateSmartersNew.config11) && this.config12.equals(onCreateSmartersNew.config12) && this.config13.equals(onCreateSmartersNew.config13) && this.config14.equals(onCreateSmartersNew.config14) && this.config15.equals(onCreateSmartersNew.config15) && this.config16.equals(onCreateSmartersNew.config16) && this.config17.equals(onCreateSmartersNew.config17) && this.config18.equals(onCreateSmartersNew.config18) && this.config19.equals(onCreateSmartersNew.config19) && this.config20.equals(onCreateSmartersNew.config20) && this.config21.equals(onCreateSmartersNew.config21) && this.config22.equals(onCreateSmartersNew.config22) && this.config23.equals(onCreateSmartersNew.config23) && this.config24.equals(onCreateSmartersNew.config24) && this.config25.equals(onCreateSmartersNew.config25) && this.config26.equals(onCreateSmartersNew.config26) && this.config27.equals(onCreateSmartersNew.config27) && this.config28.equals(onCreateSmartersNew.config28) && this.config29.equals(onCreateSmartersNew.config29) && this.config30.equals(onCreateSmartersNew.config30) && this.config31.equals(onCreateSmartersNew.config31) && this.config32.equals(onCreateSmartersNew.config32) && this.config33.equals(onCreateSmartersNew.config33) && this.config34.equals(onCreateSmartersNew.config34) && this.config35.equals(onCreateSmartersNew.config35) && this.createdAt.equals(onCreateSmartersNew.createdAt) && this.updatedAt.equals(onCreateSmartersNew.updatedAt);
        }
    ...
    public static final class Variables extends f.b {
        ...
        public Variables(S8.f fVar) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            linkedHashMap.put("filter", fVar);
        }

        public static /* synthetic */ S8.f access$000(Variables variables) {
            variables.getClass();
            return null;
        }
    ...
    public OnCreateSmartersNewSubscription(S8.f fVar) {
    ...
    public String operationId() {
        return "8cf554595e2e40c8584a6b78dfb70dd4d81524c8b921c1a3dc4ee8890257bc47";
    }

    public String queryDocument() {
        return "subscription OnCreateSmartersNew($filter: ModelSubscriptionSmartersNewFilterInput) {\n  onCreateSmartersNew(filter: $filter) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    }
    ...
    public static final class Builder {
        ...
        public OnCreateSmartersNewSubscription build() {
            return new OnCreateSmartersNewSubscription(null);
        }

        public Builder filter(S8.f fVar) {
            return this;
        }
    }
}
