...
public final class GetSmartersNewQuery implements h {
    public static final String OPERATION_DEFINITION = "query GetSmartersNew($id: ID!) {\n  getSmartersNew(id: $id) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    private static final g OPERATION_NAME = new 1();
    public static final String QUERY_DOCUMENT = "query GetSmartersNew($id: ID!) {\n  getSmartersNew(id: $id) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    private final Variables variables;

    public class 1 implements g {
        public String name() {
            return "GetSmartersNew";
        }
    }
    ...
    public static final class Builder {
        ...
        public GetSmartersNewQuery build() {
            x1.g.c(this.id, "id == null");
            return new GetSmartersNewQuery(this.id);
        }
    ...
    public static class Data implements f.a {
        static final k[] $responseFields = {k.f("getSmartersNew", "getSmartersNew", new x1.f(1).b("id", new x1.f(2).b("kind", "Variable").b("variableName", "id").a()).a(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetSmartersNew getSmartersNew;
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                ...
                GetSmartersNew getSmartersNew = Data.this.getSmartersNew;
                oVar.d(kVar, getSmartersNew != null ? getSmartersNew.marshaller() : null);
            }
        }

        public static final class Mapper implements l {
            final GetSmartersNew.Mapper getSmartersNewFieldMapper = new GetSmartersNew.Mapper();

            public class 1 implements n.c {
                public 1() {
                }

                public GetSmartersNew read(n nVar) {
                    return Mapper.this.getSmartersNewFieldMapper.map(nVar);
                }
            }

            public Data map(n nVar) {
                return new Data((GetSmartersNew) nVar.b(Data.$responseFields[0], new 1()));
            }
        }

        public Data(GetSmartersNew getSmartersNew) {
            this.getSmartersNew = getSmartersNew;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetSmartersNew getSmartersNew = this.getSmartersNew;
            GetSmartersNew getSmartersNew2 = ((Data) obj).getSmartersNew;
            return getSmartersNew == null ? getSmartersNew2 == null : getSmartersNew.equals(getSmartersNew2);
        }

        public GetSmartersNew getSmartersNew() {
            return this.getSmartersNew;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetSmartersNew getSmartersNew = this.getSmartersNew;
                this.$hashCode = (getSmartersNew == null ? 0 : getSmartersNew.hashCode()) ^ 1000003;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getSmartersNew=" + this.getSmartersNew + "}";
            }
            return this.$toString;
        }
    }

    public static class GetSmartersNew {
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                k[] kVarArr = GetSmartersNew.$responseFields;
                oVar.b(kVarArr[0], GetSmartersNew.this.__typename);
                oVar.c((k.a) kVarArr[1], GetSmartersNew.this.id);
                oVar.b(kVarArr[2], GetSmartersNew.this.config1);
                oVar.b(kVarArr[3], GetSmartersNew.this.config2);
                oVar.b(kVarArr[4], GetSmartersNew.this.config3);
                oVar.b(kVarArr[5], GetSmartersNew.this.config4);
                oVar.b(kVarArr[6], GetSmartersNew.this.config5);
                oVar.b(kVarArr[7], GetSmartersNew.this.config6);
                oVar.b(kVarArr[8], GetSmartersNew.this.config7);
                oVar.b(kVarArr[9], GetSmartersNew.this.config8);
                oVar.b(kVarArr[10], GetSmartersNew.this.config9);
                oVar.b(kVarArr[11], GetSmartersNew.this.config10);
                oVar.b(kVarArr[12], GetSmartersNew.this.config11);
                oVar.b(kVarArr[13], GetSmartersNew.this.config12);
                oVar.b(kVarArr[14], GetSmartersNew.this.config13);
                oVar.b(kVarArr[15], GetSmartersNew.this.config14);
                oVar.b(kVarArr[16], GetSmartersNew.this.config15);
                oVar.b(kVarArr[17], GetSmartersNew.this.config16);
                oVar.b(kVarArr[18], GetSmartersNew.this.config17);
                oVar.b(kVarArr[19], GetSmartersNew.this.config18);
                oVar.b(kVarArr[20], GetSmartersNew.this.config19);
                oVar.b(kVarArr[21], GetSmartersNew.this.config20);
                oVar.b(kVarArr[22], GetSmartersNew.this.config21);
                oVar.b(kVarArr[23], GetSmartersNew.this.config22);
                oVar.b(kVarArr[24], GetSmartersNew.this.config23);
                oVar.b(kVarArr[25], GetSmartersNew.this.config24);
                oVar.b(kVarArr[26], GetSmartersNew.this.config25);
                oVar.b(kVarArr[27], GetSmartersNew.this.config26);
                oVar.b(kVarArr[28], GetSmartersNew.this.config27);
                oVar.b(kVarArr[29], GetSmartersNew.this.config28);
                oVar.b(kVarArr[30], GetSmartersNew.this.config29);
                oVar.b(kVarArr[31], GetSmartersNew.this.config30);
                oVar.b(kVarArr[32], GetSmartersNew.this.config31);
                oVar.b(kVarArr[33], GetSmartersNew.this.config32);
                oVar.b(kVarArr[34], GetSmartersNew.this.config33);
                oVar.b(kVarArr[35], GetSmartersNew.this.config34);
                oVar.b(kVarArr[36], GetSmartersNew.this.config35);
                oVar.c((k.a) kVarArr[37], GetSmartersNew.this.createdAt);
                oVar.c((k.a) kVarArr[38], GetSmartersNew.this.updatedAt);
            }
        }

        public static final class Mapper implements l {
            public GetSmartersNew map(n nVar) {
                k[] kVarArr = GetSmartersNew.$responseFields;
                return new GetSmartersNew(nVar.c(kVarArr[0]), (String) nVar.d((k.a) kVarArr[1]), nVar.c(kVarArr[2]), nVar.c(kVarArr[3]), nVar.c(kVarArr[4]), nVar.c(kVarArr[5]), nVar.c(kVarArr[6]), nVar.c(kVarArr[7]), nVar.c(kVarArr[8]), nVar.c(kVarArr[9]), nVar.c(kVarArr[10]), nVar.c(kVarArr[11]), nVar.c(kVarArr[12]), nVar.c(kVarArr[13]), nVar.c(kVarArr[14]), nVar.c(kVarArr[15]), nVar.c(kVarArr[16]), nVar.c(kVarArr[17]), nVar.c(kVarArr[18]), nVar.c(kVarArr[19]), nVar.c(kVarArr[20]), nVar.c(kVarArr[21]), nVar.c(kVarArr[22]), nVar.c(kVarArr[23]), nVar.c(kVarArr[24]), nVar.c(kVarArr[25]), nVar.c(kVarArr[26]), nVar.c(kVarArr[27]), nVar.c(kVarArr[28]), nVar.c(kVarArr[29]), nVar.c(kVarArr[30]), nVar.c(kVarArr[31]), nVar.c(kVarArr[32]), nVar.c(kVarArr[33]), nVar.c(kVarArr[34]), nVar.c(kVarArr[35]), nVar.c(kVarArr[36]), (String) nVar.d((k.a) kVarArr[37]), (String) nVar.d((k.a) kVarArr[38]));
            }
        }
        ...
        public GetSmartersNew(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20, String str21, String str22, String str23, String str24, String str25, String str26, String str27, String str28, String str29, String str30, String str31, String str32, String str33, String str34, String str35, String str36, String str37, String str38, String str39) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetSmartersNew)) {
                return false;
            }
            GetSmartersNew getSmartersNew = (GetSmartersNew) obj;
            return this.__typename.equals(getSmartersNew.__typename) && this.id.equals(getSmartersNew.id) && this.config1.equals(getSmartersNew.config1) && this.config2.equals(getSmartersNew.config2) && this.config3.equals(getSmartersNew.config3) && this.config4.equals(getSmartersNew.config4) && this.config5.equals(getSmartersNew.config5) && this.config6.equals(getSmartersNew.config6) && this.config7.equals(getSmartersNew.config7) && this.config8.equals(getSmartersNew.config8) && this.config9.equals(getSmartersNew.config9) && this.config10.equals(getSmartersNew.config10) && this.config11.equals(getSmartersNew.config11) && this.config12.equals(getSmartersNew.config12) && this.config13.equals(getSmartersNew.config13) && this.config14.equals(getSmartersNew.config14) && this.config15.equals(getSmartersNew.config15) && this.config16.equals(getSmartersNew.config16) && this.config17.equals(getSmartersNew.config17) && this.config18.equals(getSmartersNew.config18) && this.config19.equals(getSmartersNew.config19) && this.config20.equals(getSmartersNew.config20) && this.config21.equals(getSmartersNew.config21) && this.config22.equals(getSmartersNew.config22) && this.config23.equals(getSmartersNew.config23) && this.config24.equals(getSmartersNew.config24) && this.config25.equals(getSmartersNew.config25) && this.config26.equals(getSmartersNew.config26) && this.config27.equals(getSmartersNew.config27) && this.config28.equals(getSmartersNew.config28) && this.config29.equals(getSmartersNew.config29) && this.config30.equals(getSmartersNew.config30) && this.config31.equals(getSmartersNew.config31) && this.config32.equals(getSmartersNew.config32) && this.config33.equals(getSmartersNew.config33) && this.config34.equals(getSmartersNew.config34) && this.config35.equals(getSmartersNew.config35) && this.createdAt.equals(getSmartersNew.createdAt) && this.updatedAt.equals(getSmartersNew.updatedAt);
        }
    ...
    public static final class Variables extends f.b {
        ...
        public class 1 implements c {
            ...
            public void marshal(d dVar) throws IOException {
                dVar.c("id", Variables.access$000(Variables.this));
            }
        }
        ...
        public static /* synthetic */ String access$000(Variables variables) {
            return variables.id;
        }
    ...
    public GetSmartersNewQuery(String str) {
        x1.g.c(str, "id == null");
    ...
    public String operationId() {
        return "910d92089c4572f608fbd4ade40b312cd6be7dbb30ac0a46f2026ba68abb1c6c";
    }

    public String queryDocument() {
        return "query GetSmartersNew($id: ID!) {\n  getSmartersNew(id: $id) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    }
