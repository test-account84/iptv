...
public final class ListSmartersNewsQuery implements h {
    public static final String OPERATION_DEFINITION = "query ListSmartersNews($filter: ModelSmartersNewFilterInput, $limit: Int, $nextToken: String) {\n  listSmartersNews(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      config1\n      config2\n      config3\n      config4\n      config5\n      config6\n      config7\n      config8\n      config9\n      config10\n      config11\n      config12\n      config13\n      config14\n      config15\n      config16\n      config17\n      config18\n      config19\n      config20\n      config21\n      config22\n      config23\n      config24\n      config25\n      config26\n      config27\n      config28\n      config29\n      config30\n      config31\n      config32\n      config33\n      config34\n      config35\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final g OPERATION_NAME = new 1();
    public static final String QUERY_DOCUMENT = "query ListSmartersNews($filter: ModelSmartersNewFilterInput, $limit: Int, $nextToken: String) {\n  listSmartersNews(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      config1\n      config2\n      config3\n      config4\n      config5\n      config6\n      config7\n      config8\n      config9\n      config10\n      config11\n      config12\n      config13\n      config14\n      config15\n      config16\n      config17\n      config18\n      config19\n      config20\n      config21\n      config22\n      config23\n      config24\n      config25\n      config26\n      config27\n      config28\n      config29\n      config30\n      config31\n      config32\n      config33\n      config34\n      config35\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private final Variables variables;

    public class 1 implements g {
        public String name() {
            return "ListSmartersNews";
        }
    }

    public static class Data implements f.a {
        static final k[] $responseFields = {k.f("listSmartersNews", "listSmartersNews", new x1.f(3).b("filter", new x1.f(2).b("kind", "Variable").b("variableName", "filter").a()).b("nextToken", new x1.f(2).b("kind", "Variable").b("variableName", "nextToken").a()).b("limit", new x1.f(2).b("kind", "Variable").b("variableName", "limit").a()).a(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListSmartersNews listSmartersNews;
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                ...
                ListSmartersNews listSmartersNews = Data.this.listSmartersNews;
                oVar.d(kVar, listSmartersNews != null ? listSmartersNews.marshaller() : null);
            }
        }

        public static final class Mapper implements l {
            final ListSmartersNews.Mapper listSmartersNewsFieldMapper = new ListSmartersNews.Mapper();

            public class 1 implements n.c {
                public 1() {
                }

                public ListSmartersNews read(n nVar) {
                    return Mapper.this.listSmartersNewsFieldMapper.map(nVar);
                }
            }

            public Data map(n nVar) {
                return new Data((ListSmartersNews) nVar.b(Data.$responseFields[0], new 1()));
            }
        }

        public Data(ListSmartersNews listSmartersNews) {
            this.listSmartersNews = listSmartersNews;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListSmartersNews listSmartersNews = this.listSmartersNews;
            ListSmartersNews listSmartersNews2 = ((Data) obj).listSmartersNews;
            return listSmartersNews == null ? listSmartersNews2 == null : listSmartersNews.equals(listSmartersNews2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListSmartersNews listSmartersNews = this.listSmartersNews;
                this.$hashCode = (listSmartersNews == null ? 0 : listSmartersNews.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListSmartersNews listSmartersNews() {
            return this.listSmartersNews;
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listSmartersNews=" + this.listSmartersNews + "}";
            }
    ...
    public static class Item {
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                k[] kVarArr = Item.$responseFields;
                oVar.b(kVarArr[0], Item.this.__typename);
                oVar.c((k.a) kVarArr[1], Item.this.id);
                oVar.b(kVarArr[2], Item.this.config1);
                oVar.b(kVarArr[3], Item.this.config2);
                oVar.b(kVarArr[4], Item.this.config3);
                oVar.b(kVarArr[5], Item.this.config4);
                oVar.b(kVarArr[6], Item.this.config5);
                oVar.b(kVarArr[7], Item.this.config6);
                oVar.b(kVarArr[8], Item.this.config7);
                oVar.b(kVarArr[9], Item.this.config8);
                oVar.b(kVarArr[10], Item.this.config9);
                oVar.b(kVarArr[11], Item.this.config10);
                oVar.b(kVarArr[12], Item.this.config11);
                oVar.b(kVarArr[13], Item.this.config12);
                oVar.b(kVarArr[14], Item.this.config13);
                oVar.b(kVarArr[15], Item.this.config14);
                oVar.b(kVarArr[16], Item.this.config15);
                oVar.b(kVarArr[17], Item.this.config16);
                oVar.b(kVarArr[18], Item.this.config17);
                oVar.b(kVarArr[19], Item.this.config18);
                oVar.b(kVarArr[20], Item.this.config19);
                oVar.b(kVarArr[21], Item.this.config20);
                oVar.b(kVarArr[22], Item.this.config21);
                oVar.b(kVarArr[23], Item.this.config22);
                oVar.b(kVarArr[24], Item.this.config23);
                oVar.b(kVarArr[25], Item.this.config24);
                oVar.b(kVarArr[26], Item.this.config25);
                oVar.b(kVarArr[27], Item.this.config26);
                oVar.b(kVarArr[28], Item.this.config27);
                oVar.b(kVarArr[29], Item.this.config28);
                oVar.b(kVarArr[30], Item.this.config29);
                oVar.b(kVarArr[31], Item.this.config30);
                oVar.b(kVarArr[32], Item.this.config31);
                oVar.b(kVarArr[33], Item.this.config32);
                oVar.b(kVarArr[34], Item.this.config33);
                oVar.b(kVarArr[35], Item.this.config34);
                oVar.b(kVarArr[36], Item.this.config35);
                oVar.c((k.a) kVarArr[37], Item.this.createdAt);
                oVar.c((k.a) kVarArr[38], Item.this.updatedAt);
            }
        }
        ...
        public boolean equals(Object obj) {
            ...
            Item item = (Item) obj;
            return this.__typename.equals(item.__typename) && this.id.equals(item.id) && this.config1.equals(item.config1) && this.config2.equals(item.config2) && this.config3.equals(item.config3) && this.config4.equals(item.config4) && this.config5.equals(item.config5) && this.config6.equals(item.config6) && this.config7.equals(item.config7) && this.config8.equals(item.config8) && this.config9.equals(item.config9) && this.config10.equals(item.config10) && this.config11.equals(item.config11) && this.config12.equals(item.config12) && this.config13.equals(item.config13) && this.config14.equals(item.config14) && this.config15.equals(item.config15) && this.config16.equals(item.config16) && this.config17.equals(item.config17) && this.config18.equals(item.config18) && this.config19.equals(item.config19) && this.config20.equals(item.config20) && this.config21.equals(item.config21) && this.config22.equals(item.config22) && this.config23.equals(item.config23) && this.config24.equals(item.config24) && this.config25.equals(item.config25) && this.config26.equals(item.config26) && this.config27.equals(item.config27) && this.config28.equals(item.config28) && this.config29.equals(item.config29) && this.config30.equals(item.config30) && this.config31.equals(item.config31) && this.config32.equals(item.config32) && this.config33.equals(item.config33) && this.config34.equals(item.config34) && this.config35.equals(item.config35) && this.createdAt.equals(item.createdAt) && this.updatedAt.equals(item.updatedAt);
        }
    ...
    public static class ListSmartersNews {
        static final k[] $responseFields = {k.g("__typename", "__typename", null, false, Collections.emptyList()), k.e("items", "items", null, false, Collections.emptyList()), k.g("nextToken", "nextToken", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final String __typename;
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                k[] kVarArr = ListSmartersNews.$responseFields;
                oVar.b(kVarArr[0], ListSmartersNews.this.__typename);
                oVar.a(kVarArr[1], ListSmartersNews.this.items, new 1());
                oVar.b(kVarArr[2], ListSmartersNews.this.nextToken);
            }
        }
        ...
        public static final class Mapper implements l {
            ...
            public class 1 implements n.b {

                public class 1 implements n.c {
                    public 1() {
                    }

                    public Item read(n nVar) {
                        return Mapper.this.itemFieldMapper.map(nVar);
                    }
                }
                ...
                public Item read(n.a aVar) {
                    return (Item) aVar.a(new 1());
                }
            }

            public ListSmartersNews map(n nVar) {
                k[] kVarArr = ListSmartersNews.$responseFields;
                return new ListSmartersNews(nVar.c(kVarArr[0]), nVar.a(kVarArr[1], new 1()), nVar.c(kVarArr[2]));
            }
        }

        public ListSmartersNews(String str, List list, String str2) {
            this.__typename = (String) x1.g.c(str, "__typename == null");
            this.items = (List) x1.g.c(list, "items == null");
            this.nextToken = str2;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListSmartersNews)) {
                return false;
            }
            ListSmartersNews listSmartersNews = (ListSmartersNews) obj;
            if (this.__typename.equals(listSmartersNews.__typename) && this.items.equals(listSmartersNews.items)) {
                String str = this.nextToken;
                String str2 = listSmartersNews.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListSmartersNews{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends f.b {
        ...
        public class 1 implements c {
            ...
            public void marshal(d dVar) throws IOException {
                ...
                dVar.a("filter", null);
                dVar.b("limit", Variables.access$100(Variables.this));
                dVar.c("nextToken", Variables.access$200(Variables.this));
            }
        }
        ...
        public static /* synthetic */ Integer access$100(Variables variables) {
            return variables.limit;
        }

        public static /* synthetic */ String access$200(Variables variables) {
    ...
    public ListSmartersNewsQuery(e eVar, Integer num, String str) {
    ...
    public String operationId() {
        return "0f7cf57ad010651fbc09090de1cc6c50b2c8d73c56b5e5cfe19b352c7ae38aed";
    }

    public String queryDocument() {
        return "query ListSmartersNews($filter: ModelSmartersNewFilterInput, $limit: Int, $nextToken: String) {\n  listSmartersNews(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      config1\n      config2\n      config3\n      config4\n      config5\n      config6\n      config7\n      config8\n      config9\n      config10\n      config11\n      config12\n      config13\n      config14\n      config15\n      config16\n      config17\n      config18\n      config19\n      config20\n      config21\n      config22\n      config23\n      config24\n      config25\n      config26\n      config27\n      config28\n      config29\n      config30\n      config31\n      config32\n      config33\n      config34\n      config35\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
    ...
    public static final class Builder {
        ...
        public ListSmartersNewsQuery build() {
            return new ListSmartersNewsQuery(null, this.limit, this.nextToken);
        }
