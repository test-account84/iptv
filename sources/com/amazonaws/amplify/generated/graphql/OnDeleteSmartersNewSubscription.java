...
public final class OnDeleteSmartersNewSubscription implements t {
    public static final String OPERATION_DEFINITION = "subscription OnDeleteSmartersNew($filter: ModelSubscriptionSmartersNewFilterInput) {\n  onDeleteSmartersNew(filter: $filter) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    private static final g OPERATION_NAME = new 1();
    public static final String QUERY_DOCUMENT = "subscription OnDeleteSmartersNew($filter: ModelSubscriptionSmartersNewFilterInput) {\n  onDeleteSmartersNew(filter: $filter) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    private final Variables variables;

    public class 1 implements g {
        public String name() {
            return "OnDeleteSmartersNew";
        }
    }

    public static class Data implements f.a {
        static final k[] $responseFields = {k.f("onDeleteSmartersNew", "onDeleteSmartersNew", new x1.f(1).b("filter", new x1.f(2).b("kind", "Variable").b("variableName", "filter").a()).a(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnDeleteSmartersNew onDeleteSmartersNew;
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                ...
                OnDeleteSmartersNew onDeleteSmartersNew = Data.this.onDeleteSmartersNew;
                oVar.d(kVar, onDeleteSmartersNew != null ? onDeleteSmartersNew.marshaller() : null);
            }
        }

        public static final class Mapper implements l {
            final OnDeleteSmartersNew.Mapper onDeleteSmartersNewFieldMapper = new OnDeleteSmartersNew.Mapper();

            public class 1 implements n.c {
                public 1() {
                }

                public OnDeleteSmartersNew read(n nVar) {
                    return Mapper.this.onDeleteSmartersNewFieldMapper.map(nVar);
                }
            }

            public Data map(n nVar) {
                return new Data((OnDeleteSmartersNew) nVar.b(Data.$responseFields[0], new 1()));
            }
        }

        public Data(OnDeleteSmartersNew onDeleteSmartersNew) {
            this.onDeleteSmartersNew = onDeleteSmartersNew;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnDeleteSmartersNew onDeleteSmartersNew = this.onDeleteSmartersNew;
            OnDeleteSmartersNew onDeleteSmartersNew2 = ((Data) obj).onDeleteSmartersNew;
            return onDeleteSmartersNew == null ? onDeleteSmartersNew2 == null : onDeleteSmartersNew.equals(onDeleteSmartersNew2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnDeleteSmartersNew onDeleteSmartersNew = this.onDeleteSmartersNew;
                this.$hashCode = (onDeleteSmartersNew == null ? 0 : onDeleteSmartersNew.hashCode()) ^ 1000003;
        ...
        public OnDeleteSmartersNew onDeleteSmartersNew() {
            return this.onDeleteSmartersNew;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onDeleteSmartersNew=" + this.onDeleteSmartersNew + "}";
            }
            return this.$toString;
        }
    }

    public static class OnDeleteSmartersNew {
        ...
        public class 1 implements m {
            ...
            public void marshal(o oVar) {
                k[] kVarArr = OnDeleteSmartersNew.$responseFields;
                oVar.b(kVarArr[0], OnDeleteSmartersNew.this.__typename);
                oVar.c((k.a) kVarArr[1], OnDeleteSmartersNew.this.id);
                oVar.b(kVarArr[2], OnDeleteSmartersNew.this.config1);
                oVar.b(kVarArr[3], OnDeleteSmartersNew.this.config2);
                oVar.b(kVarArr[4], OnDeleteSmartersNew.this.config3);
                oVar.b(kVarArr[5], OnDeleteSmartersNew.this.config4);
                oVar.b(kVarArr[6], OnDeleteSmartersNew.this.config5);
                oVar.b(kVarArr[7], OnDeleteSmartersNew.this.config6);
                oVar.b(kVarArr[8], OnDeleteSmartersNew.this.config7);
                oVar.b(kVarArr[9], OnDeleteSmartersNew.this.config8);
                oVar.b(kVarArr[10], OnDeleteSmartersNew.this.config9);
                oVar.b(kVarArr[11], OnDeleteSmartersNew.this.config10);
                oVar.b(kVarArr[12], OnDeleteSmartersNew.this.config11);
                oVar.b(kVarArr[13], OnDeleteSmartersNew.this.config12);
                oVar.b(kVarArr[14], OnDeleteSmartersNew.this.config13);
                oVar.b(kVarArr[15], OnDeleteSmartersNew.this.config14);
                oVar.b(kVarArr[16], OnDeleteSmartersNew.this.config15);
                oVar.b(kVarArr[17], OnDeleteSmartersNew.this.config16);
                oVar.b(kVarArr[18], OnDeleteSmartersNew.this.config17);
                oVar.b(kVarArr[19], OnDeleteSmartersNew.this.config18);
                oVar.b(kVarArr[20], OnDeleteSmartersNew.this.config19);
                oVar.b(kVarArr[21], OnDeleteSmartersNew.this.config20);
                oVar.b(kVarArr[22], OnDeleteSmartersNew.this.config21);
                oVar.b(kVarArr[23], OnDeleteSmartersNew.this.config22);
                oVar.b(kVarArr[24], OnDeleteSmartersNew.this.config23);
                oVar.b(kVarArr[25], OnDeleteSmartersNew.this.config24);
                oVar.b(kVarArr[26], OnDeleteSmartersNew.this.config25);
                oVar.b(kVarArr[27], OnDeleteSmartersNew.this.config26);
                oVar.b(kVarArr[28], OnDeleteSmartersNew.this.config27);
                oVar.b(kVarArr[29], OnDeleteSmartersNew.this.config28);
                oVar.b(kVarArr[30], OnDeleteSmartersNew.this.config29);
                oVar.b(kVarArr[31], OnDeleteSmartersNew.this.config30);
                oVar.b(kVarArr[32], OnDeleteSmartersNew.this.config31);
                oVar.b(kVarArr[33], OnDeleteSmartersNew.this.config32);
                oVar.b(kVarArr[34], OnDeleteSmartersNew.this.config33);
                oVar.b(kVarArr[35], OnDeleteSmartersNew.this.config34);
                oVar.b(kVarArr[36], OnDeleteSmartersNew.this.config35);
                oVar.c((k.a) kVarArr[37], OnDeleteSmartersNew.this.createdAt);
                oVar.c((k.a) kVarArr[38], OnDeleteSmartersNew.this.updatedAt);
            }
        }

        public static final class Mapper implements l {
            public OnDeleteSmartersNew map(n nVar) {
                k[] kVarArr = OnDeleteSmartersNew.$responseFields;
                return new OnDeleteSmartersNew(nVar.c(kVarArr[0]), (String) nVar.d((k.a) kVarArr[1]), nVar.c(kVarArr[2]), nVar.c(kVarArr[3]), nVar.c(kVarArr[4]), nVar.c(kVarArr[5]), nVar.c(kVarArr[6]), nVar.c(kVarArr[7]), nVar.c(kVarArr[8]), nVar.c(kVarArr[9]), nVar.c(kVarArr[10]), nVar.c(kVarArr[11]), nVar.c(kVarArr[12]), nVar.c(kVarArr[13]), nVar.c(kVarArr[14]), nVar.c(kVarArr[15]), nVar.c(kVarArr[16]), nVar.c(kVarArr[17]), nVar.c(kVarArr[18]), nVar.c(kVarArr[19]), nVar.c(kVarArr[20]), nVar.c(kVarArr[21]), nVar.c(kVarArr[22]), nVar.c(kVarArr[23]), nVar.c(kVarArr[24]), nVar.c(kVarArr[25]), nVar.c(kVarArr[26]), nVar.c(kVarArr[27]), nVar.c(kVarArr[28]), nVar.c(kVarArr[29]), nVar.c(kVarArr[30]), nVar.c(kVarArr[31]), nVar.c(kVarArr[32]), nVar.c(kVarArr[33]), nVar.c(kVarArr[34]), nVar.c(kVarArr[35]), nVar.c(kVarArr[36]), (String) nVar.d((k.a) kVarArr[37]), (String) nVar.d((k.a) kVarArr[38]));
            }
        }
        ...
        public OnDeleteSmartersNew(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20, String str21, String str22, String str23, String str24, String str25, String str26, String str27, String str28, String str29, String str30, String str31, String str32, String str33, String str34, String str35, String str36, String str37, String str38, String str39) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnDeleteSmartersNew)) {
                return false;
            }
            OnDeleteSmartersNew onDeleteSmartersNew = (OnDeleteSmartersNew) obj;
            return this.__typename.equals(onDeleteSmartersNew.__typename) && this.id.equals(onDeleteSmartersNew.id) && this.config1.equals(onDeleteSmartersNew.config1) && this.config2.equals(onDeleteSmartersNew.config2) && this.config3.equals(onDeleteSmartersNew.config3) && this.config4.equals(onDeleteSmartersNew.config4) && this.config5.equals(onDeleteSmartersNew.config5) && this.config6.equals(onDeleteSmartersNew.config6) && this.config7.equals(onDeleteSmartersNew.config7) && this.config8.equals(onDeleteSmartersNew.config8) && this.config9.equals(onDeleteSmartersNew.config9) && this.config10.equals(onDeleteSmartersNew.config10) && this.config11.equals(onDeleteSmartersNew.config11) && this.config12.equals(onDeleteSmartersNew.config12) && this.config13.equals(onDeleteSmartersNew.config13) && this.config14.equals(onDeleteSmartersNew.config14) && this.config15.equals(onDeleteSmartersNew.config15) && this.config16.equals(onDeleteSmartersNew.config16) && this.config17.equals(onDeleteSmartersNew.config17) && this.config18.equals(onDeleteSmartersNew.config18) && this.config19.equals(onDeleteSmartersNew.config19) && this.config20.equals(onDeleteSmartersNew.config20) && this.config21.equals(onDeleteSmartersNew.config21) && this.config22.equals(onDeleteSmartersNew.config22) && this.config23.equals(onDeleteSmartersNew.config23) && this.config24.equals(onDeleteSmartersNew.config24) && this.config25.equals(onDeleteSmartersNew.config25) && this.config26.equals(onDeleteSmartersNew.config26) && this.config27.equals(onDeleteSmartersNew.config27) && this.config28.equals(onDeleteSmartersNew.config28) && this.config29.equals(onDeleteSmartersNew.config29) && this.config30.equals(onDeleteSmartersNew.config30) && this.config31.equals(onDeleteSmartersNew.config31) && this.config32.equals(onDeleteSmartersNew.config32) && this.config33.equals(onDeleteSmartersNew.config33) && this.config34.equals(onDeleteSmartersNew.config34) && this.config35.equals(onDeleteSmartersNew.config35) && this.createdAt.equals(onDeleteSmartersNew.createdAt) && this.updatedAt.equals(onDeleteSmartersNew.updatedAt);
        }
    ...
    public OnDeleteSmartersNewSubscription(S8.f fVar) {
    ...
    public String operationId() {
        return "3a5eb24ec52299e845100a997684117df6c6513e46dd56d3f593231593059f2b";
    }

    public String queryDocument() {
        return "subscription OnDeleteSmartersNew($filter: ModelSubscriptionSmartersNewFilterInput) {\n  onDeleteSmartersNew(filter: $filter) {\n    __typename\n    id\n    config1\n    config2\n    config3\n    config4\n    config5\n    config6\n    config7\n    config8\n    config9\n    config10\n    config11\n    config12\n    config13\n    config14\n    config15\n    config16\n    config17\n    config18\n    config19\n    config20\n    config21\n    config22\n    config23\n    config24\n    config25\n    config26\n    config27\n    config28\n    config29\n    config30\n    config31\n    config32\n    config33\n    config34\n    config35\n    createdAt\n    updatedAt\n  }\n}";
    }
    ...
    public static final class Builder {
        ...
        public OnDeleteSmartersNewSubscription build() {
            return new OnDeleteSmartersNewSubscription(null);
        }
