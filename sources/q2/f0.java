...
public final class f0 {
    ...
    public f0(int i, int i2, float f, float f2, int i3) {
        this.a = i;
        this.b = i2;
        this.c = f;
        this.d = f2;
    ...
    public static void p(int i, int i2, short[] sArr, int i3, short[] sArr2, int i4, short[] sArr3, int i5) {
    ...
    public final void b(float f) {
        ...
        do {
            if (this.r > 0) {
                ...
                double d = f;
                short[] sArr = this.j;
                w = d > 1.0d ? g + w(sArr, i2, f, g) : m(sArr, i2, f, g);
            }
            i2 += w;
        } while (this.h + i2 <= i);
        v(i2);
    ...
    public final int m(short[] sArr, int i, float f, int i2) {
        int i3;
        if (f < 0.5f) {
            i3 = (int) ((i2 * f) / (1.0f - f));
        } else {
    ...
    public final short n(short[] sArr, int i, int i2, int i3) {
        short s = sArr[i];
    ...
    public final int w(short[] sArr, int i, float f, int i2) {
        int i3;
        if (f >= 2.0f) {
            i3 = (int) (i2 / (f - 1.0f));
        } else {
