...
public final class Cache implements Closeable, Flushable {
    ...
    public static final class CacheResponseBody extends ResponseBody {
        ...
        public CacheResponseBody(@NotNull DiskLruCache.Snapshot snapshot, @Nullable String str, @Nullable String str2) {
            ...
            this.bodySource = Okio.buffer(new 1(source, source));
        }
    ...
    public static final class Companion {
        ...
        private final Set varyFields(Headers headers) {
            ...
            for (int i = 0; i < size; i++) {
                if (n.o("Vary", headers.name(i), true)) {
                    String value = headers.value(i);
                    if (treeSet == null) {
                        treeSet = new TreeSet(n.p(E.a));
                    }
                    for (String str : o.r0(value, new char[]{','}, false, 0, 6, null)) {
                        if (str == null) {
        ...
        public final boolean varyMatches(@NotNull Response cachedResponse, @NotNull Headers cachedRequest, @NotNull Request newRequest) {
            ...
            Collection<String> collection = (Iterable) varyFields(cachedResponse.headers());
        ...
        public static final class 1 extends ForwardingSink {
            ...
            public void close() throws IOException {
                synchronized (RealCacheRequest.this.this$0) {
                    ...
                    super.close();
                    RealCacheRequest.access$getEditor$p(RealCacheRequest.this).commit();
                }
            }
        }
    ...
    public static final class 1 implements Iterator, x8.a {
