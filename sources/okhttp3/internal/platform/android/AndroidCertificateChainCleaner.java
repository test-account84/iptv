...
public final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public AndroidCertificateChainCleaner(@NotNull X509TrustManager trustManager, @NotNull X509TrustManagerExtensions x509TrustManagerExtensions) {
        l.e(trustManager, "trustManager");
        l.e(x509TrustManagerExtensions, "x509TrustManagerExtensions");
    ...
    public List clean(@NotNull List chain, @NotNull String hostname) throws SSLPeerUnverifiedException {
        ...
        Object[] array = ((Collection) chain).toArray(new X509Certificate[0]);
        if (array == null) {
            throw new NullPointerException("null cannot be cast to non-null type kotlin.Array<T>");
        }
        try {
            List checkServerTrusted = this.x509TrustManagerExtensions.checkServerTrusted((X509Certificate[]) array, "RSA", hostname);
            l.d(checkServerTrusted, "x509TrustManagerExtensio…ficates, \"RSA\", hostname)");
