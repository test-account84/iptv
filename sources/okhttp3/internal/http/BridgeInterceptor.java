...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(@NotNull Interceptor.Chain chain) throws IOException {
        ...
        Collection loadForRequest = this.cookieJar.loadForRequest(request.url());
        ...
        if (z && n.o("gzip", Response.header$default(proceed, "Content-Encoding", null, 2, null), true) && HttpHeaders.promisesBody(proceed) && (body = proceed.body()) != null) {
